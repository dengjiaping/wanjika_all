...
$_LANG['use_gift'] = '使用礼品卡';
$_LANG['use_bonus_kill'] = '使用线下优惠券';
$_LANG['invoice'] = '开发票';
...
$_LANG['avalible_payment_null'] = '无可用的支付方式，请重新选择商品。';
...
$_LANG['charge_calls_fail'] = '话费充值失败，请尽快联系商家';
...
$_LANG['gift_card_oos'] = '礼品卡已缺货';
$_LANG['phone_card_oos'] = '充值卡已缺货';
