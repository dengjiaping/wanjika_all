 ...
 * ============================================================================
 * $Author: liubo $
 * $Id: phone_card.php 17217 2011-01-19 06:29:08Z liubo $
*/
...
$_LANG['phone_card_list'] = '虚拟商品列表'; 
$_LANG['lab_goods_name'] = '商品名称';
$_LANG['lab_cz_money'] = '充值金额';
$_LANG['replenish'] = '补货';
...
$_LANG['batch_card_merge'] = '批量合并充值卡';
...
$_LANG['not_set_patchnum'] = '未指定充值卡数量';
$_LANG['not_set_merge_param'] = '请选择合并订单';
$_LANG['batch_card_add_ok'] = '已成功添加了 %s 条补货信息';
$_LANG['batch_card_merge_ok'] = '已成功合并了 %s 条充值卡';
$_LANG['batch_card_delay_ok'] = '已成功延期了 %s 条充值卡';
...
$_LANG['js_languages']['uploadfile_not_null'] = '请指定充值卡有效期';

$_LANG['use_help'] = '使用说明：' .
        '<ol>' .
          '<li>充值卡批量生成规则在对应充值卡商品的属性中选择配置<br />' .
              '只需要指定批量生成的充值卡数量和失效时间即可<br />'.
