...
$_LANG['notice_payments'] = '(请选择该商品可用的支付方式，默认全部可用。如果不想让该物品可买，请下架而不是将所有支付方式都不选。)';
...
$_LANG['js_languages']['warn_payments_not_null'] = '支付方式不能为空';
...
/*zhao*/ 
/* 礼品卡 */
$_LANG['gift_card'] = '查看礼品卡信息';
$_LANG['add_replenish'] = '添加礼品卡卡密';
