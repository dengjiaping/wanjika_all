...
$_LANG['label_referer'] = '订单来源：';
$_LANG['label_charge'] = '是否为话费充值订单：';
...
$_LANG['label_bonus'] = '使用优惠券：';
$_LANG['label_gift'] = '使用礼品卡：';
...
$_LANG['bonus_not_available'] = '该订单使用优惠券支付，现在优惠券不可用';
...
$_LANG['merge'] = '合并';
$_LANG['notice_order_sn'] = '当两个订单不一致时，合并后的订单信息（如：支付方式、配送方式、包装、贺卡、优惠券等）以主订单为准。';
