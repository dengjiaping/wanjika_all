...
*/
/* 优惠券类型字段信息 */
$_LANG['bonus_type'] = '优惠券类型';
$_LANG['bonus_list'] = '优惠券列表';
...
$_LANG['use_goods_id'] = '适用商品';
$_LANG['use_goods_type'] = '适用商品分类';
$_LANG['use_bonus_goods'] = '优惠券适用商品';
$_LANG['use_bonus_paylist'] = '优惠券适用支付方式';
...
$_LANG['send'] = '发放';
$_LANG['bonus_excel_file'] = '线下优惠券信息列表';
...
$_LANG['sendbonus_count'] = '共发送了 %d 个优惠券。';
$_LANG['send_bouns_error'] = '发送会员优惠券出错, 请返回重试！';
$_LANG['no_select_bonus'] = '您没有选择需要删除的用户优惠券';
$_LANG['bonustype_edit'] = '编辑优惠券类型';
$_LANG['bonustype_view'] = '查看详情';
$_LANG['drop_bonus'] = '删除优惠券';
$_LANG['send_bonus'] = '发放优惠券';
$_LANG['continus_add'] = '继续添加优惠券类型';
$_LANG['back_list'] = '返回优惠券类型列表';
$_LANG['continue_add'] = '继续添加优惠券';
$_LANG['back_bonus_list'] = '返回优惠券列表';
...
$_LANG['js_languages']['bonus_sn_empty'] = '请输入优惠券的序列号!';
$_LANG['js_languages']['bonus_sn_number'] = '优惠券的序列号必须是数字!';
$_LANG['send_count_error'] = '优惠券的发放数量必须是一个整数!';
$_LANG['js_languages']['bonus_sum_empty'] = '请输入您要发放的优惠券数量!';
$_LANG['js_languages']['bonus_sum_number'] = '优惠券的发放数量必须是一个整数!';
$_LANG['js_languages']['bonus_type_empty'] = '请选择优惠券的类型金额!';
...
$_LANG['bonus_sn_notic'] = '提示:优惠券序列号由六位序列号种子加上四位随机数字组成';
$_LANG['creat_bonus'] = '生成了 ';
$_LANG['creat_bonus_num'] = ' 个优惠券序列号';
$_LANG['bonus_sn_error'] = '优惠券序列号必须是数字!';
$_LANG['send_user_notice'] = '给指定的用户发放优惠券时,请在此输入用户名, 多个用户之间请用逗号(,)分隔开<br />如:liry, wjz, zwj';

/* 优惠券信息字段 */
$_LANG['bonus_id'] = '编号';
$_LANG['bonus_type_id'] = '类型金额';
$_LANG['send_bonus_count'] = '优惠券数量';
$_LANG['start_bonus_sn'] = '起始序列号';
$_LANG['bonus_sn'] = '优惠券序列号';
$_LANG['user_id'] = '使用会员';
...
$_LANG['confirm_send_bonus'] = '确定发送优惠券';
$_LANG['bonus_not_exist'] = '该优惠券不存在';
