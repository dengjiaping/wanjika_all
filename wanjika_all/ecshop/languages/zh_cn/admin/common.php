...
$_LANG['17_gift_card_manage'] = '礼品卡管理';
$_LANG['18_phone_card_manage'] = '电话卡管理';
$_LANG['19_moviecode_manage'] = '院线认证';
$_LANG['20_card_lottery'] = '礼品卡转盘抽奖';
$_LANG['21_data_capture'] = '抓取数据';
...
$_LANG['53_gift_card_list'] = '礼品卡列表';
$_LANG['54_gift_card_add'] = '添加礼品卡';
$_LANG['55_gift_card_all'] = '礼品卡管理';
$_LANG['goods_auto'] = '商品自动上下架';
$_LANG['article_auto'] = '文章自动发布';
$_LANG['navigator'] = '自定义导航栏';
$_LANG['56_charge_calls_list'] = '话费充值商品列表';
$_LANG['57_charge_calls_add'] = '添加话费充值商品';
$_LANG['58_charge_calls_config_list'] = '话费充值配置列表';
$_LANG['59_charge_calls_config_add'] = '添加话费配置';
$_LANG['putaway_goods'] = '商品上下架';

/* 促销管理 */
$_LANG['02_snatch_list'] = '夺宝奇兵';
$_LANG['snatch_add'] = '添加夺宝奇兵';
$_LANG['04_bonustype_list'] = '优惠券类型';
$_LANG['bonustype_add'] = '添加优惠券类型';
$_LANG['05_bonus_list'] = '线下优惠券';
$_LANG['bonus_add'] = '添加会员优惠券';
...
$_LANG['11_patch_order'] = '批量生成订单';
$_LANG['12_suixin_refund'] = '闪白条退款申请列表';
...
$_LANG['um_bill'] = '联动优势交易文件';
$_LANG['um_settle'] = '联动优势清算文件';
...
$_LANG['patch_user_by_mobile'] = '批量导入用户';
...
$_LANG['ad_header'] = '顶通广告管理';
$_LANG['floor_manage'] = '首页楼层图管理';
...
$_LANG['07_sms_template'] = '发送模板短信';
$_LANG['08_sms_sendsms'] = '营销短信';
$_LANG['09_sms_virtualresult'] = '虚拟短信发送结果';
$_LANG['10_sms_sendresult'] = '发送结果列表';
...
$_LANG['gift_card_manage'] = '礼品卡管理';
$_LANG['add_gift_card'] = '添加礼品卡';
$_LANG['gift_card_list'] = '礼品卡列表';

$_LANG['phone_card_manage'] = '充值卡管理';
$_LANG['add_phone_card'] = '添加充值卡';
$_LANG['phone_card_list'] = '充值卡列表';
...
$_LANG['moviecode_validate'] = '验证院线码';
$_LANG['moviecode_upload'] = '上传院线码';
$_LANG['moviecode_add'] = '新增院线';
$_LANG['moviecode_owner_list'] = '院线供应商列表';
$_LANG['moviecode_code_list'] = '院线码列表';

/* 礼品卡转盘抽奖 */
$_LANG['01_lottery_list'] = '查看中奖信息';

/*抓取京东数据*/
$_LANG['01_data_config'] = '数据抓取配置';
$_LANG['02_data_list'] = '数据抓取列表';
$_LANG['capture_jderji'] = '抓取京东耳机数据';
?>
