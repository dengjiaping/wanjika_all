...
function get_artcatname()
{
    $art_sql = 'SELECT cat_id,cat_name FROM ' . $GLOBALS['ecs']->table('article_cat');
    $result = $GLOBALS['db']->getAll($art_sql);
    $artcat_names = array();
    foreach($result as $row){
        $artcat_names[$row["cat_id"]] = $row["cat_name"];
    }
