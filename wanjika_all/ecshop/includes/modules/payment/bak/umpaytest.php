...
$umpay = new umpay();
$str = "merId=7145&goodsId=937&goodsInf=1&mobileId=13581753069&amtType=02&bankType=3&version=3.0";
$res = $umpay->ssl_sign($str);
echo $res;
exit;
...
class umpay
{
	...
	function get_code($order, $payment)
	{
		...
		print_r($payment);
		exit;*/
		$priv_key_file = $_SERVER['DOCUMENT_ROOT']."/includes/7145_WanJiKe.key.pem";
