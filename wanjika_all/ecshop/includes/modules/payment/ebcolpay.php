...
//        $userbankcustom='';//网银客户号
        $cardtype='01';//卡类型
        $usertype='0';//用户类型
        $banktburl='http://www.wjike.com/user.php?act=order_list';//页面通知地址
        $dstburl='http://www.wjike.com/pay/ebcolRcvPay.php';//后台通知地址
        ...
        $def_url .= "<input type='submit' name='submit' value='".$GLOBALS['_LANG']['ebcpay_button']."' />";
        $def_url .= "</form></div><br />";
        return $def_url;
	}
}
