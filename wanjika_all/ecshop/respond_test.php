...
$rank_sql = "SELECT mobile_phone FROM " . $ecs->table('users') . " WHERE user_id = '1'";
...
$_REQUEST = unserialize(base64_decode($tmp[0]));
/* 支付方式代码 */
...
//手机支付方式
if (empty($pay_code) && ($_REQUEST['merchantId'] == '888073157340001') )
{
    $pay_code = 'mobpay';
}
