...
//商品管理权限
    ...
    $purview['53_gift_card_list'] = 'virualcard';
    $purview['54_gift_card_add'] = 'virualcard';
    $purview['55_gift_card_all'] = 'virualcard';
    $purview['putaway_goods'] = 'putaway_goods';
//促销管理权限
...
//会员管理权限
    ...
    $purview['patch_user_by_mobile'] = 'feedback_priv';
...
//订单管理权限
    ...
    $purview['11_patch_order'] = 'order_view';
...
//报表统计权限
	...
	$purview['um_bill'] = 'sale_order_stats';
	$purview['um_settle'] = 'sale_order_stats';
...
//短信管理
    ...
    $purview['07_sms_template'] = 'sms_send';
...
//礼品卡管理
    $purview['gift_card_manage']       = 'gift_card_manage';
    $purview['add_gift_card']           = 'add_gift_card';
    $purview['gift_card_list']        = 'gift_card_list';
//充值卡管理
    $purview['phone_card_manage']       = 'phone_card_manage';
    $purview['add_phone_card']           = 'add_phone_card';
    $purview['phone_card_list']        = 'phone_card_list';
    
//院线管理
	$purview['moviecode_validate']       = 'moviecode_validate';
    $purview['moviecode_upload']           = 'moviecode_upload';
    $purview['moviecode_owner_list']        = 'moviecode_owner_list';
    $purview['moviecode_code_list']        = 'moviecode_code_list';
    $purview['moviecode_add']        = 'moviecode_add';

//抓取数据
//    $purview['capture_jderji']        ='capture_jderji';
?>