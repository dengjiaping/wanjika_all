...
/*zhao*/
$modules['02_cat_and_goods']['53_gift_card_list']   = 'goods.php?act=list&extension_code=gift_card';
$modules['02_cat_and_goods']['54_gift_card_add']    = 'goods.php?act=add&extension_code=gift_card';
$modules['02_cat_and_goods']['55_gift_card_all']    = 'gift_card.php?act=card';
$modules['02_cat_and_goods']['goods_auto']             = 'goods_auto.php?act=list';
$modules['02_cat_and_goods']['56_charge_calls_list']   = 'goods.php?act=list&extension_code=charge_calls';
$modules['02_cat_and_goods']['57_charge_calls_add']    = 'goods.php?act=add&extension_code=charge_calls';
$modules['02_cat_and_goods']['58_charge_calls_config_list']   = 'charge.php?act=list';
$modules['02_cat_and_goods']['59_charge_calls_config_add']    = 'charge.php?act=add';
...
$modules['04_order']['11_patch_order']               = 'order.php?act=patch_order_by_mobile';
$modules['04_order']['12_suixin_refund']               = 'order.php?act=refundlist&status=1';
...
$modules['06_stats']['um_bill']                   = 'um_bill.php?act=list';
$modules['06_stats']['um_settle']                   = 'um_settle.php?act=list';
...
$modules['08_members']['patch_user_by_mobile']            = 'user_msg.php?act=patch_user_by_mobile';
...
$modules['11_system']['ad_header']             = 'ad_header.php';
$modules['11_system']['floor_manage']             = 'floor_manage.php';
...
$modules['14_sms']['07_sms_template']                   = 'sms.php?act=send_template_sms';
$modules['14_sms']['08_sms_sendsms']                   = 'mysms.php?act=display_send_ui';
$modules['14_sms']['09_sms_virtualresult']                   = 'mysms_virtual.php?act=list';
$modules['14_sms']['10_sms_sendresult']                   = 'mysms.php?act=list';
...
$modules['17_gift_card_manage']['gift_card_manage']           = 'gift_card.php?act=card';
$modules['17_gift_card_manage']['add_gift_card']        = 'goods.php?act=add&extension_code=gift_card';
$modules['17_gift_card_manage']['gift_card_list']       = 'goods.php?act=list&extension_code=gift_card';

$modules['18_phone_card_manage']['phone_card_manage']           = 'phone_card.php?act=card';
$modules['18_phone_card_manage']['add_phone_card']        = 'goods.php?act=add&extension_code=phone_card';
$modules['18_phone_card_manage']['phone_card_list']       = 'goods.php?act=list&extension_code=phone_card';

$modules['19_moviecode_manage']['moviecode_validate'] = 'moviecode.php?act=validate';
$modules['19_moviecode_manage']['moviecode_upload'] = 'moviecode.php?act=upload';
$modules['19_moviecode_manage']['moviecode_add'] = 'moviecode.php?act=add';
$modules['19_moviecode_manage']['moviecode_owner_list'] = 'moviecode.php?act=owner_list';
$modules['19_moviecode_manage']['moviecode_code_list'] = 'moviecode.php?act=code_list';

$modules['20_card_lottery']['01_lottery_list']       = 'lottery.php?act=list';         // 查看中奖信息

$modules['21_data_capture']['01_data_config']            ='grasp_dataconfig.php?act=list';        //抓取京东耳机数据
$modules['21_data_capture']['02_data_list']            ='grasp_datalist.php?act=list';        //抓取京东耳机数据
$modules['21_data_capture']['capture_jderji']            ='capture_jderji.php?act=list';        //抓取京东耳机数据
?>
