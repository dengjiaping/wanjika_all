...
if ($_REQUEST['act'] == 'add')
{
	...
	$smarty->assign('use_goods_list',  $goods_list);
...
if ($_REQUEST['act'] == 'insert')
{
    ...
    /* 插入数据库。 */
    $sql = "INSERT INTO ".$ecs->table('bonus_type')." (type_name, type_money,send_start_date,send_end_date,use_start_date,use_end_date,send_type,min_amount,min_goods_amount,use_goods_ids, pay_ids)
    VALUES ('$type_name',
            '$_POST[type_money]',
            '$send_startdate',
            '$send_enddate',
            ...
            '$use_enddate',
            '$_POST[send_type]',
            '$min_amount','" . floatval($_POST['min_goods_amount']) . "', '$use_goods_ids_str', '$pay_ids_str')";
