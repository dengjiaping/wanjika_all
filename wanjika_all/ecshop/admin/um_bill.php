 ...
 * ECSHOP 联动优势交易文件
 * $Author: xuan $
 * $Id: um_bill.php 17217 2014-04-14 06:29:08Z 
*/
...
if (isset($_REQUEST['act']) && $_REQUEST['act'] == 'query')
{
	...
	//支付日期
	$payDate = str_replace("-","",$_REQUEST['start_date']);
	//银行编号
	$gateId = "02";
	//版本
	$version = "3.0";
	...
	//手机钱包商户接入规范3.1V的5.9组装字符串，生成签名
 	$url = "merId=" . $merId . "&payDate=" . $payDate . "&version=" . $version;
	//签名
	...
	echo "<form style=\"display:none\" name=\"transform\" action=\"http://payment.umpay.com/hfwebbusi/bill/trans.dl\" method=\"post\">
<h2><b>交易数据对帐信息：</b></h2>	
<TABLE width=\"100%\" >
