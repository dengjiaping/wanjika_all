...
else
{
    ...
    /* 查询商品 */
    $sql = "SELECT g.goods_id, g.goods_cuxiao, g.goods_name, g.market_price, g.is_new, g.is_best, g.is_hot, g.shop_price AS org_price, ".
    ...
    while ($row = $db->FetchRow($res))
    {
        ...
        $arr[$row['goods_id']]['cuxiao']          = $row['goods_cuxiao'];
