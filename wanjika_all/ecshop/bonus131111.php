...
$bonus_index_arr = array(1 => 9, 2 => 11, 3 => 10);
...
if ($_REQUEST['act'] == 'getbonus')
{
	...
	$now = time();
	if ($now <= strtotime('2013-11-05 00:00:00') || $now >= strtotime('2013-11-12 00:00:00'))
	{
...
if (!$smarty->is_cached('getbonus131111.dwt'))
{
 	assign_template();
	$position = assign_ur_here(0, '领取双11优惠券');
...
$smarty->display('bonus131111.dwt');