...
function addGift()
{
  var frm      = document.forms['addGift'];
...
function mergeGift()
{
  var frm      = document.forms['mergeGift'];
  var gift_sn = frm.elements['gift_sn'].value;
...
function addPhone()
{
  var frm      = document.forms['addPhone'];
  var phone_sn = frm.elements['phone_sn'].value;
  var phone_password = frm.elements['phone_password'].value;

  if (phone_sn.length == 0||phone_password.length == 0)
  {
    alert(phone_sn_empty);
    return false;
  }
  else
  {
...
function czPhone()
{
  var frm      = document.forms['czPhone'];
  var phone_sn = frm.elements['phone_sn'].value;
  var cz_phone_sn = frm.elements['cz_phone_sn'].value;

  if (phone_sn.length == 0)
  {
    alert(phone_sn_empty);
    return false;
  }
