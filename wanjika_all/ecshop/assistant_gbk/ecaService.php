...
function hello($name) {
    ...
    return base64_encode('Hello, ' . $name. ';====================;ASSISTANT_VERSION: 1.27 20091227;ECS_CHARSET: '.ECS_CHARSET.';====================;EC_CHARSET: '.EC_CHARSET.';VERSION: '.VERSION.';RELEASE: '.RELEASE.';PHP_VERSION: '.PHP_VERSION);
}
