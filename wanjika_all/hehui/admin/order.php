...
elseif ($_REQUEST['act'] == 'list')
{
	if ($_REQUEST['download']=='下载') {
		...
		$str_down = "订单号\t合并订单号\t商品名称\t下单时间\t地址\t电话\t手机\t最佳送货时间\t收货人\t商品数量\t折扣\t发票税额\t配送费用\t保价费用\t支付费用\t包装费用\t贺卡费用\t商品总金额\t已付款金额\t订单状态\t发货状态\t支付状态\t支付方式";
		...
		while ( list ( $key, $val ) = each ( $list['orders'] ) ) {
			...
			$val['pay_name'] = str_replace('<font color="#FF0000">', '', $val['pay_name']);
			$val['pay_name'] = str_replace('</font>', '', $val['pay_name']);
...
function order_list()
{
    ...
    if ($result === false)
    {
		...
		/*$sql = "SELECT o.order_id, o.order_sn, o.country, u.mobile_phone, o.province, o.city, o.district, o.add_time, o.address, o.mobile,o.order_status, o.shipping_status, o.order_amount, o.money_paid," ."o.pay_status, o.pay_source, o.consignee, o.address, o.email, o.tel, o.extension_code, o.extension_id, o.pay_name, g.goods_number, g.goods_price, " .
        ...
        $sql = "SELECT o.order_id, o.order_sn, o.country, u.mobile_phone, o.province, o.city, o.district, o.add_time, o.address, o.mobile, o.order_status, o.shipping_status, o.order_amount, o.money_paid," . "o.pay_status, o.consignee, o.address, o.email, o.tel, o.extension_code, o.extension_id, o.pay_name, g.goods_number, g.goods_price, " . "o.discount,o.tax,o.shipping_fee,o.insure_fee,o.pay_fee,o.pack_fee,o.card_fee,o.best_time," .
                    "(" . order_amount_field('o.') . ") AS total_fee, " .
                    "IFNULL(u.user_name, '" .$GLOBALS['_LANG']['anonymous']. "') AS buyer, g.goods_name  ".
                " FROM " . $GLOBALS['ecs']->table('order_info') . " AS o " .
                " LEFT JOIN " .$GLOBALS['ecs']->table('users'). " AS u ON u.user_id=o.user_id ". 
