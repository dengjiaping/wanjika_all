...
$payment_lang = ROOT_PATH . 'languages/zh_cn/payment/mobpay.php';
...
if (isset($_POST['submit']) && $_POST['submit']=='手机支付') {
    ...
    $productName  = mb_convert_encoding("玩机咖商品", "gb2312", "UTF-8");;
...
class mobpay
{
	...
	function get_code($order, $payment)
	{
		...
		'action="/includes/modules/payment/mobpay.php" enctype="multipart/form-data" target="_blank">';
		...
		$def_url .= "<input type='submit' name='submit' value='手机支付' />";
		$def_url .= "</form></div><br />";
