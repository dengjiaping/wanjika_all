...
$file_name = "/web/logs/mobRcv_notify_".date("Ymd").".log";
...
require(ROOT_PATH . 'includes/modules/payment/mobpay/globalParam.php');
require(ROOT_PATH . 'includes/modules/payment/mobpay/callcmpay.php');
