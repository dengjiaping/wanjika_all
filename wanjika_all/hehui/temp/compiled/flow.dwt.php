...
?>
        ...
        <table width="99%" align="center" border="0" cellpadding="5" cellspacing="0" bgcolor="#dddddd">
          <tr>
            <td bgcolor="#ffffff"><a href="./"><img src="themes/ecmoban_ehaier/images/continue.gif" alt="continue" /></a></td>
            <td bgcolor="#ffffff" align="right"><a href="flow.php?step=checkout"><img src="themes/ecmoban_ehaier/images/checkout.gif" alt="checkout" /></a></td>
          </tr>
        </table>
...
?>
            <ul class="clearfix">
              ...
              <li>
                ...
                <a href="javascript:fittings_to_flow(<?php echo $this->_var['fittings']['goods_id']; ?>,<?php echo $this->_var['fittings']['parent_id']; ?>)"><img src="themes/ecmoban_ehaier/images/bnt_buy.gif" alt="<?php echo $this->_var['lang']['collect_to_flow']; ?>" /></a>
              </li>
            </ul>
          <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
        </div>
...
?><br />
            ...
            <tr>
              ...
              <td align="center" bgcolor="#ffffff"><input type="image" src="themes/ecmoban_ehaier/images/bnt_cat.gif" alt="Add to cart"  border="0" /></td>
            </tr>
            <?php endif; ?>
          </table>
...
?>
            ...
            <tr>
              ...
              <td align="right" bgcolor="#ffffff" valign="top"><?php echo $this->_var['payment']['format_pay_fee']; ?></td>
                        	            ...
                        	            <?php if ($this->_var['payment']['pay_code'] == "olpay"): ?>
                        	              	<tr id="olpayicons" style="display:;">
                        	              		<td align="center" colspan="4" bgcolor="#ffffff" valign="top" style="text-align:left;">
                        	              			<label style="display:inline;float:left;width:160px;border:1px solid #CCCCCC;cursor:pointer;margin:5px 10px 5px 0;padding:5px;">
                        	              				<input type="radio" value="jsyh" name="bankradios" id="jsyhrdo" checked=true />
                        	              				<img src="themes/ecmoban_ehaier/images/jsyh.png" />
                        	              			</label>
                        	              			<label style="display:inline;float:left;width:160px;border:1px solid #CCCCCC;cursor:pointer;margin:5px 10px 5px 0;padding:5px;">
                        	              				<input type="radio" value="gsyh" name="bankradios" id="jsyhrdo"/>
                        	              				<img src="themes/ecmoban_ehaier/images/gsyh.png" />
                        	              			</label>
                        	              			<label style="display:inline;float:left;width:160px;border:1px solid #CCCCCC;cursor:pointer;margin:5px 10px 5px 0;padding:5px;">
                        	              				<input type="radio" value="yzcx" name="bankradios" id="jsyhrdo"/>
                        	              				<img src="themes/ecmoban_ehaier/images/yzcx.png" />
                        	              			</label>
                        	              			<label style="display:inline;float:left;width:160px;border:1px solid #CCCCCC;cursor:pointer;margin:5px 10px 5px 0;padding:5px;">
                        	              				<input type="radio" value="nyyh" name="bankradios" id="jsyhrdo"/>
                        	              				<img src="themes/ecmoban_ehaier/images/nyyh.png" />
                        	              			</label>
                        	              			<label style="display:inline;float:left;width:160px;border:1px solid #CCCCCC;cursor:pointer;margin:5px 10px 5px 0;padding:5px;">
                        	              				<input type="radio" value="zgyh" name="bankradios" id="jsyhrdo"/>
                        	              				<img src="themes/ecmoban_ehaier/images/zgyh.png" />
                        	              			</label>
                        	              			<label style="display:inline;float:left;width:160px;border:1px solid #CCCCCC;cursor:pointer;margin:5px 10px 5px 0;padding:5px;">
                        	              				<input type="radio" value="pfyh" name="bankradios" id="jsyhrdo"/>
                        	              				<img src="themes/ecmoban_ehaier/images/pfyh.png" />
                        	              			</label>
                        	              			<label style="display:inline;float:left;width:160px;border:1px solid #CCCCCC;cursor:pointer;margin:5px 10px 5px 0;padding:5px;">
                        	              				<input type="radio" value="jtyh" name="bankradios" id="jsyhrdo"/>
                        	              				<img src="themes/ecmoban_ehaier/images/jtyh.png" />
                        	              			</label>
                        	              			<label style="display:inline;float:left;width:160px;border:1px solid #CCCCCC;cursor:pointer;margin:5px 10px 5px 0;padding:5px;">
                        	              				<input type="radio" value="zsyh" name="bankradios" id="jsyhrdo"/>
                        	              				<img src="themes/ecmoban_ehaier/images/zsyh.png" />
                        	              			</label>
                        	              			<label style="display:inline;float:left;width:160px;border:1px solid #CCCCCC;cursor:pointer;margin:5px 10px 5px 0;padding:5px;">
                        	              				<input type="radio" value="msyh" name="bankradios" id="jsyhrdo"/>
                        	              				<img src="themes/ecmoban_ehaier/images/msyh.png" />
                        	              			</label>
                        	              			<label style="display:inline;float:left;width:160px;border:1px solid #CCCCCC;cursor:pointer;margin:5px 10px 5px 0;padding:5px;">
                        	              				<input type="radio" value="fzyh" name="bankradios" id="jsyhrdo"/>
                        	              				<img src="themes/ecmoban_ehaier/images/fzyh.png" />
                        	              			</label>
                        	              			<label style="display:inline;float:left;width:160px;border:1px solid #CCCCCC;cursor:pointer;margin:5px 10px 5px 0;padding:5px;">
                        	              				<input type="radio" value="zxyh" name="bankradios" id="jsyhrdo"/>
                        	              				<img src="themes/ecmoban_ehaier/images/zxyh.png" />
                        	              			</label>
                        	              			<label style="display:inline;float:left;width:160px;border:1px solid #CCCCCC;cursor:pointer;margin:5px 10px 5px 0;padding:5px;">
                        	              				<input type="radio" value="gfyh" name="bankradios" id="jsyhrdo"/>
                        	              				<img src="themes/ecmoban_ehaier/images/gfyh.png" />
                        	              			</label>
                        	              			<label style="display:inline;float:left;width:160px;border:1px solid #CCCCCC;cursor:pointer;margin:5px 10px 5px 0;padding:5px;">
                        	              				<input type="radio" value="hxyh" name="bankradios" id="jsyhrdo"/>
                        	              				<img src="themes/ecmoban_ehaier/images/hxyh.png" />
                        	              			</label>
                        	              			<label style="display:inline;float:left;width:160px;border:1px solid #CCCCCC;cursor:pointer;margin:5px 10px 5px 0;padding:5px;">
                        	              				<input type="radio" value="xyyh" name="bankradios" id="jsyhrdo"/>
                        	              				<img src="themes/ecmoban_ehaier/images/xyyh.png" />
                        	              			</label>
                        	              		</td>
                        	              	</tr>
                        	            <?php endif; ?>
    ...
    <h6><span><?php echo $this->_var['lang']['fee_total']; ?></span></h6>
          <?php echo $this->fetch('library/order_total.lbi'); ?>
           <div align="center" style="margin:8px auto;">
            <input type="image" src="themes/ecmoban_ehaier/images/bnt_subOrder.gif" />
