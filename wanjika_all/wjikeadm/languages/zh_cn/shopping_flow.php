...
$_LANG['invalid_bonus'] = "您选择的优惠券并不存在。";
$_LANG['invalid_gift'] = "您选择的礼品卡并不存在。";
...
$_LANG['select_bonus_again'] = '请重新选择优惠券';
$_LANG['goods_is_lack'] = '已下架或缺货，请重新修改订单！';
...
$_LANG['fat_ext'][FAT_GOODS] = '从下面的赠品或特惠品中选择 %d 个（0表示不限制数量），选择后点击放入购物车按钮。';
...
$_LANG['validate_bonus'] = '验证优惠券';
$_LANG['input_bonus_no'] = '或者输入优惠券序列号';
$_LANG['select_bonus'] = '选择已有优惠券';
$_LANG['bonus_sn_error'] = '该优惠券序列号不正确';
$_LANG['bonus_min_amount_error'] = '订单商品金额没有达到使用该优惠券的最低金额 %s';
$_LANG['bonus_is_ok'] = '该优惠券序列号可以使用，可以抵扣 %s';
$_LANG['bonus_invalid_payment'] = '该优惠券不支持目前选定的支付方式';


$_LANG['validate_gift'] = '验证礼品卡';
$_LANG['input_gift_no'] = '或者输入礼品卡序列号';
$_LANG['select_gift'] = '选择已有礼品卡';
$_LANG['gift_sn_error'] = '该礼品卡序列号不正确';
$_LANG['gift_min_amount_error'] = '订单商品金额没有达到使用该礼品卡的最低金额 %s';
$_LANG['gift_is_ok'] = '该礼品卡序列号可以使用，可以抵扣 %s';
