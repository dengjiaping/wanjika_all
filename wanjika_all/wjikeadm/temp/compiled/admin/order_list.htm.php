...
<table cellpadding="3" cellspacing="1">
  <tr>
	...
	<th><?php echo $this->_var['lang']['order_coty_sn']; ?></th>
...
?>
  <tr>
    ...
    <td><?php echo $this->_var['order']['pay_source']; ?></td>
...
<?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
	...
	function copy_code(sn) 
	{
		if (window.clipboardData) 
		{
			var order_sn_element = document.getElementById("ordersn_" + sn);
			var copyText = order_sn_element.value;
