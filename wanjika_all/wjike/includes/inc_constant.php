...
/* 拆单状态 */
define('SS_UNNEED',                1); // 不需要拆单
define('SS_NEED',                  2); // 需要拆单
define('SS_ALREADY',               3); // 已拆单
...
define('SS_SHIPPED_KJT',            7); // 已出库待通关

/* 支付状态 */
define('PS_UNPAYED',                0); // 未付款
define('PS_PAYING',                 1); // 付款中
define('PS_PAYED',                  2); // 已付款
define('PS_PAYFU_PART',             3); // 部分退款
define('PS_PAYFU',                  4); // 已退款
...
define('ADD_SURPLUS',              10); // 增加签到基础积分
define('ADD_EXTRA_SURPLUS',        11); // 增加签到额外积分
...
/* 跨境通任务状态 */
define('CREATE_ORDER_SUCC',                11); // 下单成功
define('CREATE_ORDER_FAL',                  12); // 下单失败
define('CANCEL_ORDER',                  13); // 订单取消
define('DELETE_ORDER_SUCC',                  14); // 订单作废成功

/* 盛付通任务状态 */
define('BILLING_SUCC',                11); // 代扣成功
define('BILLING_FAL',                 12); // 代扣失败
define('DECLARE_SUCC',                21); // 支付申报成功
define('DECLARE_FAL',                 22); // 支付申报失败
define('DECLARE_NOTICE_SUCC',        31); // 支付申报通知成功
define('DECLARE_NOTICE_FAL',         32); // 支付申报通知失败
?>