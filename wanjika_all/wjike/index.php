...
if (!$smarty->is_cached('index.dwt', $cache_id))
{
    ...
    $arr_id=array(1320,1321);
    $arr_id=assign_get_price($arr_id);//获取该组商品ID的商品价格
    $position = assign_ur_here();
    $smarty->assign('arr_id',      $arr_id);    // 页面标题
...
//    $smarty->assign('venues',          get_all_venue()); // 场馆类
    $smarty->assign('is_index',        true); // 首页标识
 ...
 * @arr_id  array
 */
function assign_get_price($arr_id)
{
    $arr=array();
