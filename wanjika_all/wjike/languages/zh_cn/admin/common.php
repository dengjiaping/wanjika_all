...
$_LANG['54_goods_members_list'] = '会员充值商品列表';
$_LANG['55_goods_members_add'] = '添加会员充值商品';
...
$_LANG['56_gift_card_list'] = '礼品卡列表';
$_LANG['57_gift_card_add'] = '添加礼品卡';
$_LANG['58_gift_card_all'] = '礼品卡管理';
$_LANG['goods_auto'] = '商品自动上下架';
$_LANG['article_auto'] = '文章自动发布';
$_LANG['navigator'] = '自定义导航栏';
$_LANG['59_erp_category_list'] = 'ERP商品分类';
$_LANG['erp_category_list'] = '添加ERP分类';
$_LANG['60_warehouse_list'] = '商品仓库';
$_LANG['add_warehouse'] = '添加商品仓库';
$_LANG['61_country_list'] = '商品国家';
$_LANG['add_country'] = '添加商品国家';
$_LANG['venue_manage'] = '场馆管理';
$_LANG['add_venue'] = '添加';
$_LANG['brand_zone'] = '品牌专区';
...
$_LANG['11_tradeno_list'] = '支付流水号列表';
$_LANG['12_add_tradeno'] = '添加支付流水号';
$_LANG['13_order_import'] = '订单导入';
$_LANG['14_warehouse_import'] = '出库单导入';
$_LANG['15_warehouse_line_import'] = '线下海淘订单导入';
$_LANG['16_refund_list'] = '退款列表';
$_LANG['17_failetask_list'] = '推送失败订单列表';
...
$_LANG['11_user_addmembers'] = '添加VIP会员配置';
$_LANG['12_user_memberslist'] = 'VIP会员配置列表';
$_LANG['13_user_memberintegral'] = '会员等级积分配置列表';
$_LANG['14_user_sign_config'] = '签到配置后台';
