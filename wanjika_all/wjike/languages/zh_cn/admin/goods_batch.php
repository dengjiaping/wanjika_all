...
$_LANG['upload_goods']['goods_barcode'] = '产品条形码';
$_LANG['upload_goods']['kjt_goods_id'] = 'KJT商品ID';
$_LANG['upload_goods']['min_price'] = '最低价格';
$_LANG['upload_goods']['supplier_id'] = '商品仓库';
$_LANG['upload_goods']['overseas_logo'] = '产地';
$_LANG['upload_goods']['is_immediately'] = '是否立即购买';
$_LANG['upload_goods']['max_number'] = '商品最大数量设置';
$_LANG['upload_goods']['cat_id'] = '所属分类';
