...
$_LANG['label_profile'] = '我的信息';
$_LANG['label_order'] = '我的订单';
$_LANG['label_address'] = '收货地址管理';
...
/* 会员红包 */
$_LANG['bonus_is_used'] = '您输入的优惠劵已经领取过了';
...
$_LANG['bonus_add_expire'] = '该优惠券已经过期！';
$_LANG['bonus_use_expire'] = '该优惠券已经过了使用期！';
$_LANG['bonus_is_use'] = '您已经领过该类型优惠劵';
...
$_LANG['ss'][SS_SHIPPED_KJT] = '已出库,待通关';

$_LANG['ps'][PS_UNPAYED] = '未付款';
$_LANG['ps'][PS_PAYING] = '付款中';
$_LANG['ps'][PS_PAYED] = '已付款';
$_LANG['ps'][PS_PAYFU_PART] = '部分退款';
$_LANG['ps'][PS_PAYFU] = '已退款';
...
$_LANG['passport_js']['captcha_empty'] = '- 验证码不能为空。';
