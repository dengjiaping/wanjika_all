...
Calendar.prototype.create = function (_par) {
	...
	if (this.isPopup) {
		div.style.position = sign ? "fixed":"absolute";
  ...
  if ((version >= 5.5) && (document.body.filters))
  {
    ...
    if(sign)
    {
        ...
        this.title = hh("签到成功", 7, 300);
        this.title.className = "title";
        this.title.style.background = "#fff";
        this.title.style.width = "100%";
        this.title.style.backgroundColor = "#45ba9f";
        this.title.style.height = "60px";
    ...
    if(sign)
    {
	    this.title.style.background = "#ececec";
...
Calendar.prototype._init = function (firstDayOfWeek, date) {
    ...
    if(sign)
    {
        ...
        this.table.style.minHeight = "500px";
    }
...
Calendar.prototype._displayWeekdays = function () {
	...
	for (var i = 0; i < 7; ++i) {
        ...
        if(sign)
        {
            cell.innerHTML=cell.innerHTML.replace(/\"/g,"");//签到页面去除半角双引号
        }
		cell = cell.nextSibling;
	}
};
...
function showSign(format, showsTime, showsOtherMonths, selbtn,signarray) {
    window.sign = true;
    window.signarray = signarray;
    if (selbtn == '')
    {
        selbtn = 'selbtn';
    }
    ...
    if (_dynarch_popupCalendar != null) {
        ...
        var cal = new Calendar(1, null, null, closeHandler);
        cal.weekNumbers = false;
        if (typeof showsTime == "string") {
            cal.showsTime = true;
            cal.time24 = (showsTime == "24");
...
//        alert(result.content);
    ...
    else
    {
        ...
        document.getElementById("sign_day").innerText = result.continuity_sign;
        document.getElementById("user_points").innerText = result.user_points;
        showSign('%Y-%m-%d %H:%M', '24', false, 'sign_btn',result.content);
