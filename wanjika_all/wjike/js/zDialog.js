...
Dialog.prototype.create = function () {
  ...
  <table id="_DialogTable_' + this.ID + '" width="' + (this.Width + 26) + '" cellspacing="0" cellpadding="0" border="0" onselectstart="return false;" style="-moz-user-select: none; font-size:12px; line-height:1.4;">\
    <tr id="_Draghandle_' + this.ID + '" style="' + (this.Drag ? "cursor: default;" : "") + '">\
      <td width="13" height="33" style="background-color: #fff;border-radius: 3px 0 0 0;"><div style="width: 13px;"></div></td>\
      <td height="33" style="background-color: #fff;">\
        <div onclick="Dialog.getInstance(\'' + this.ID + '\').cancelButton.onclick.apply(Dialog.getInstance(\'' + this.ID + '\').cancelButton,[]);" onmouseout="this.style.backgroundImage=\'url(' + IMAGESPATH + 'dialog_closebtn.gif)\'" onmouseover="this.style.backgroundImage=\'url(' + IMAGESPATH + 'dialog_closebtn_over.gif)\'" style="margin-top:5px; position: relative; cursor: pointer; float: right; height: 14px; width: 14px; background-image: url(' + IMAGESPATH + 'dialog_closebtn.gif);' + (this.ShowCloseButton ? "" : "display:none;") + '"></div></td>\
      <td width="13" height="33" style="background-color: #fff;border-radius: 0 3px 0 0;"><div style="width: 13px;"><a id="_forTab_' + this.ID + '" href="#;"></a></div></td>\
    </tr>\
    <tr valign="top">\
      <td width="13" style="background-color: #fff;"></td>\
	...
	' + (function (obj) {
        ...
        return "";
          ...
          <tr id="_ButtonRow_' + this.ID + '" style="' + (this.ShowButtonRow ? "" : "display:none") + '">\
            <td height="36"><div  id="_DialogButtons_' + this.ID + '" style=" padding: 8px 18px; text-align: right;display: table; ">\
                <input type="button" class="buttonStyle" value="'+YES+'" id="_ButtonOK_' + this.ID + '"/>\
                <input type="button" class="btn color-f9 lt" style="background-color: #45ba9f;" value="'+NO+'" onclick="Dialog.getInstance(\'' + this.ID + '\').close();" id="_ButtonCancel_' + this.ID + '"/>\
              </div></td>\
          </tr>\
        </table></td>\
      <td width="13" style="background-color: #fff;"></td>\
    ...
    <tr>\
      <td width="13" height="13" style="background-color: #fff;border-radius: 0 0 0 3px;"></td>\
      <td style="background-color: #fff;"></td>\
      <td width="13" height="13" style="background-color: #fff;border-radius: 0 0 3px 0;"><a onfocus=\'$id("_forTab_' + this.ID + '").focus();\' href="#;"></a></td>\
    </tr>\
  </table>\
</div>\
'
...
Dialog.confirm = function (msg, funcOK, funcCal, w, h,pay) {
     if(pay)
     {
         YES = "完成";
         NO = "失败";
