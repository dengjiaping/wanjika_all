...
elseif ($_REQUEST['act'] == 'insert' || $_REQUEST['act'] == 'update')
{
    ...
    $favourable = array(
        ...
        'disable_coupon'=> intval($_POST['disable_coupon']) > 0 ? 1 : 0,
        ...
        'act_link'      => !empty($_POST['act_link']) ? trim($_POST['act_link']) : "",
        'mobile_act_link'      => !empty($_POST['mobile_act_link']) ? trim($_POST['mobile_act_link']) : "",
        'gift'          => serialize($gift)
    );
