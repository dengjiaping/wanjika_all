...
$modules['02_cat_and_goods']['54_goods_members_list']   = 'goods.php?act=list&extension_code=goods_members';
$modules['02_cat_and_goods']['55_goods_members_add']    = 'goods.php?act=add&extension_code=goods_members';
$modules['02_cat_and_goods']['goods_auto']             = 'goods_auto.php?act=list';
$modules['02_cat_and_goods']['56_gift_card_list']   = 'goods.php?act=list&extension_code=gift_card';
$modules['02_cat_and_goods']['57_gift_card_add']    = 'goods.php?act=add&extension_code=gift_card';
$modules['02_cat_and_goods']['58_gift_card_all']    = 'gift_card.php?act=card';
$modules['02_cat_and_goods']['59_erp_category_list']    = 'erp_category.php?act=list';//erp商品分类
$modules['02_cat_and_goods']['60_warehouse_list']    = 'goods.php?act=warehouse_list';//商品仓库
$modules['02_cat_and_goods']['61_country_list']    = 'goods.php?act=country_list';//商品国家
$modules['02_cat_and_goods']['venue_manage']    = 'venue.php?act=venue_list';//场馆管理
$modules['02_cat_and_goods']['brand_zone']    = 'brand_zone.php?act=brand_list';//品牌专区
...
$modules['04_order']['11_tradeno_list']           = 'pay_tradeno_list.php?act=tradeno_list';
$modules['04_order']['12_add_tradeno']               = 'pay_tradeno_list.php?act=tradeno_add';
$modules['04_order']['13_order_import']             = 'order.php?act=order_import';//订单导入
$modules['04_order']['14_warehouse_import']         = 'order.php?act=warehouse_import';//出库单导入
$modules['04_order']['15_warehouse_line_import']         = 'order.php?act=warehouse_line_import';//线下海淘订单导入
$modules['04_order']['16_refund_list']         = 'refund.php?act=refund_list';
$modules['04_order']['17_failetask_list']         = 'failetask.php?act=list';
...
$modules['08_members']['11_user_addmembers']             = 'users.php?act=members_add';
$modules['08_members']['12_user_memberslist']             = 'users.php?act=members_list';
$modules['08_members']['13_user_memberintegral']             = 'users.php?act=member_integral';
$modules['08_members']['14_user_sign_config']             = 'users.php?act=sign_config';
...
$modules['11_system']['index_maintain']             = 'flashplay.php?act=index_maintain';
