...
elseif ($_REQUEST['act'] == 'list')
{
    /* 检查权限 */
    admin_priv('order_view');
    if ($_REQUEST['download']=='自营用友下载') {
        require_once '../temptool/PHPExcel.php';
        require_once '../temptool/PHPExcel/Reader/Excel2007.php';
        require_once '../temptool/PHPExcel/Reader/Excel5.php';
        include_once '../temptool/PHPExcel/IOFactory.php';
        $resultPHPExcel = new PHPExcel();
        //设值
        $resultPHPExcel->getActiveSheet()->setCellValue('A1', '订单号');
        $resultPHPExcel -> getActiveSheet() -> getColumnDimension() -> setAutoSize(true);
        $resultPHPExcel->getActiveSheet()->setCellValue('B1', '订单日期');
        $resultPHPExcel->getActiveSheet()->getColumnDimension('B')->setAutoSize(true);
        $resultPHPExcel->getActiveSheet()->setCellValue('C1', '业务类型');
        $resultPHPExcel->getActiveSheet()->getColumnDimension('C')->setAutoSize(true);
        $resultPHPExcel->getActiveSheet()->setCellValue('D1', '销售类型编号');
        $resultPHPExcel->getActiveSheet()->setCellValue('E1', '客户编码');
        $resultPHPExcel->getActiveSheet()->setCellValue('F1', '客户名称');
        $resultPHPExcel->getActiveSheet()->getColumnDimension('F')->setAutoSize(true);
        $resultPHPExcel->getActiveSheet()->setCellValue('G1', '部门编码');
        $resultPHPExcel->getActiveSheet()->setCellValue('H1', '业务员编码');
        $resultPHPExcel->getActiveSheet()->setCellValue('I1', '发运方式编码');
        $resultPHPExcel->getActiveSheet()->setCellValue('J1', '发货地址');
        $resultPHPExcel->getActiveSheet()->setCellValue('K1', '联系人');
        $resultPHPExcel->getActiveSheet()->setCellValue('L1', '联系人编码');
        $resultPHPExcel->getActiveSheet()->setCellValue('M1', '币种');
        $resultPHPExcel->getActiveSheet()->setCellValue('N1', '汇率');
        $resultPHPExcel->getActiveSheet()->setCellValue('O1', '表头税率');
        $resultPHPExcel->getActiveSheet()->setCellValue('P1', '付款条件编码');
        $resultPHPExcel->getActiveSheet()->setCellValue('Q1', '必有定金');
        $resultPHPExcel->getActiveSheet()->setCellValue('R1', '定金比例');
        $resultPHPExcel->getActiveSheet()->setCellValue('S1', '定金原币金额');
        $resultPHPExcel->getActiveSheet()->setCellValue('T1', '定金本币金额');
        $resultPHPExcel->getActiveSheet()->setCellValue('U1', '表头备注');
        $resultPHPExcel->getActiveSheet()->setCellValue('V1', '订单状态');
        $resultPHPExcel->getActiveSheet()->setCellValue('W1', '制单人');
        $resultPHPExcel->getActiveSheet()->setCellValue('X1', '整单打折标志');
        $resultPHPExcel->getActiveSheet()->setCellValue('Y1', '表头自定义项1');
        $resultPHPExcel->getActiveSheet()->setCellValue('Z1', '表头自定义项2');
        $resultPHPExcel->getActiveSheet()->setCellValue('AA1', '表头自定义项3');
        $resultPHPExcel->getActiveSheet()->setCellValue('AB1', '表头自定义项4');
        $resultPHPExcel->getActiveSheet()->setCellValue('AC1', '表头自定义项5');
        $resultPHPExcel->getActiveSheet()->setCellValue('AD1', '表头自定义项6');
        $resultPHPExcel->getActiveSheet()->setCellValue('AE1', '表头自定义项7');
        $resultPHPExcel->getActiveSheet()->setCellValue('AF1', '表头自定义项8');
        $resultPHPExcel->getActiveSheet()->setCellValue('AG1', '表头自定义项9');
        $resultPHPExcel->getActiveSheet()->setCellValue('AH1', '表头自定义项10');
        $resultPHPExcel->getActiveSheet()->setCellValue('AI1', '表头自定义项11');
        $resultPHPExcel->getActiveSheet()->setCellValue('AJ1', '表头自定义项12');
        $resultPHPExcel->getActiveSheet()->setCellValue('AK1', '表头自定义项13');
        $resultPHPExcel->getActiveSheet()->setCellValue('AL1', '表头自定义项14');
        $resultPHPExcel->getActiveSheet()->setCellValue('AM1', '表头自定义项15');
        $resultPHPExcel->getActiveSheet()->setCellValue('AN1', '表头自定义项16');
        $resultPHPExcel->getActiveSheet()->setCellValue('AO1', '发货地址编码');
        $resultPHPExcel->getActiveSheet()->setCellValue('AP1', '收付款协议');
        $resultPHPExcel->getActiveSheet()->setCellValue('AQ1', '表头预发货日期');
        $resultPHPExcel->getActiveSheet()->getColumnDimension('AQ')->setAutoSize(true);
        $resultPHPExcel->getActiveSheet()->setCellValue('AR1', '表头预完工日期');
        $resultPHPExcel->getActiveSheet()->getColumnDimension('AR')->setAutoSize(true);
        $resultPHPExcel->getActiveSheet()->setCellValue('AS1', '存货编码');
        $resultPHPExcel->getActiveSheet()->getColumnDimension('AS-')->setAutoSize(true);
        $resultPHPExcel->getActiveSheet()->setCellValue('AT1', '客户存货编码');
        $resultPHPExcel->getActiveSheet()->setCellValue('AU1', '客户存货名称');
        $resultPHPExcel->getActiveSheet()->setCellValue('AV1', '主计量数量');
        $resultPHPExcel->getActiveSheet()->setCellValue('AW1', '件数');
        $resultPHPExcel->getActiveSheet()->setCellValue('AX1', '报价含税');
        $resultPHPExcel->getActiveSheet()->setCellValue('AY1', '最低售价');
        $resultPHPExcel->getActiveSheet()->setCellValue('AZ1', '赠品');
        $resultPHPExcel->getActiveSheet()->setCellValue('BA1', '报价');
        $resultPHPExcel->getActiveSheet()->setCellValue('BB1', '含税单价_原币');
        $resultPHPExcel->getActiveSheet()->setCellValue('BC1', '金额_原币_无税');
        $resultPHPExcel->getActiveSheet()->setCellValue('BD1', '税额_原币');
        $resultPHPExcel->getActiveSheet()->setCellValue('BE1', '价税合计_原币');
        $resultPHPExcel->getActiveSheet()->setCellValue('BF1', '折扣额_原币');
        $resultPHPExcel->getActiveSheet()->setCellValue('BG1', '无税单价');
        $resultPHPExcel->getActiveSheet()->setCellValue('BH1', '单价_本币_无税');
        $resultPHPExcel->getActiveSheet()->setCellValue('BI1', '金额_本币_无税');
        $resultPHPExcel->getActiveSheet()->setCellValue('BJ1', '税额_本币');
        $resultPHPExcel->getActiveSheet()->setCellValue('BK1', '价税合计_本币');
        $resultPHPExcel->getActiveSheet()->setCellValue('BL1', '折扣额');
        $resultPHPExcel->getActiveSheet()->setCellValue('BM1', '备注');
        $resultPHPExcel->getActiveSheet()->setCellValue('BN1', '自由项1');
        $resultPHPExcel->getActiveSheet()->setCellValue('BO1', '自由项2');
        $resultPHPExcel->getActiveSheet()->setCellValue('BP1', '销售订单子表id');
        $resultPHPExcel->getActiveSheet()->setCellValue('BQ1', '扣率1');
        $resultPHPExcel->getActiveSheet()->setCellValue('BR1', '扣率2');
        $resultPHPExcel->getActiveSheet()->setCellValue('BS1', '税率');
        $resultPHPExcel->getActiveSheet()->setCellValue('BT1', '自定义字段22');
        $resultPHPExcel->getActiveSheet()->setCellValue('BU1', '自定义字段23');
        $resultPHPExcel->getActiveSheet()->setCellValue('BV1', '自定义字段24');
        $resultPHPExcel->getActiveSheet()->setCellValue('BW1', '自定义字段25');
        $resultPHPExcel->getActiveSheet()->setCellValue('BX1', '自定义字段26');
        $resultPHPExcel->getActiveSheet()->setCellValue('BY1', '自定义字段27');
        $resultPHPExcel->getActiveSheet()->setCellValue('BZ1', '自定义字段28');
        $resultPHPExcel->getActiveSheet()->setCellValue('CA1', '自定义字段29');
        $resultPHPExcel->getActiveSheet()->setCellValue('CB1', '自定义字段30');
        $resultPHPExcel->getActiveSheet()->setCellValue('CC1', '自定义字段31');
        $resultPHPExcel->getActiveSheet()->setCellValue('CD1', '自定义字段32');
        $resultPHPExcel->getActiveSheet()->setCellValue('CE1', '自定义字段33');
        $resultPHPExcel->getActiveSheet()->setCellValue('CF1', '自定义字段34');
        $resultPHPExcel->getActiveSheet()->setCellValue('CG1', '自定义字段35');
        $resultPHPExcel->getActiveSheet()->setCellValue('AH1', '自定义字段36');
        $resultPHPExcel->getActiveSheet()->setCellValue('CI1', '自定义字段37');
        $resultPHPExcel->getActiveSheet()->setCellValue('CJ1', '项目');
        $resultPHPExcel->getActiveSheet()->setCellValue('CK1', '项目大类');
        $resultPHPExcel->getActiveSheet()->setCellValue('CL1', '项目名称');
        $resultPHPExcel->getActiveSheet()->setCellValue('CM1', '项目大类名称');
        $resultPHPExcel->getActiveSheet()->setCellValue('CN1', '自由项3');
        $resultPHPExcel->getActiveSheet()->setCellValue('CO1', '自由项4');
        $resultPHPExcel->getActiveSheet()->setCellValue('CP1', '自由项5');
        $resultPHPExcel->getActiveSheet()->setCellValue('CQ1', '自由项6');
        $resultPHPExcel->getActiveSheet()->setCellValue('CR1', '自由项7');
        $resultPHPExcel->getActiveSheet()->setCellValue('CS1', '自由项8');
        $resultPHPExcel->getActiveSheet()->setCellValue('CT1', '自由项9');
        $resultPHPExcel->getActiveSheet()->setCellValue('CU1', '自由项10');
        $resultPHPExcel->getActiveSheet()->setCellValue('CV1', '换算率');
        $resultPHPExcel->getActiveSheet()->setCellValue('CW1', '辅计量单位编码');
        $resultPHPExcel->getActiveSheet()->setCellValue('CX1', '预留失效日期');
        $resultPHPExcel->getActiveSheet()->setCellValue('CY1', '预完工日期');
        $resultPHPExcel->getActiveSheet()->getColumnDimension('CY')->setAutoSize(true);
        $resultPHPExcel->getActiveSheet()->setCellValue('CZ1', '预发货日期');
        $resultPHPExcel->getActiveSheet()->getColumnDimension('CZ')->setAutoSize(true);
        $resultPHPExcel->getActiveSheet()->setCellValue('DA1', '需求跟踪方式');
        $resultPHPExcel->getActiveSheet()->setCellValue('DB1', '母件需求分类代号');
        $resultPHPExcel->getActiveSheet()->setCellValue('DC1', '母件需求分类说明');
        $resultPHPExcel->getActiveSheet()->setCellValue('DD1', '子件需求分类代号');
        $resultPHPExcel->getActiveSheet()->setCellValue('DE1', '子件需求分类说明');
        $resultPHPExcel->getActiveSheet()->setCellValue('DF1', '门店销售数量');
        $resultPHPExcel->getActiveSheet()->setCellValue('DG1', '门店销售金额');
        $resultPHPExcel->getActiveSheet()->setCellValue('DH1', '门店库存数量');
        $resultPHPExcel->getActiveSheet()->setCellValue('DI1', '门店要货金额');
        $resultPHPExcel->getActiveSheet()->setCellValue('DJ1', '父节点编码');
        $resultPHPExcel->getActiveSheet()->setCellValue('DK1', '子节点编码');
        $resultPHPExcel->getActiveSheet()->setCellValue('DL1', '发货方式');
        $resultPHPExcel->getActiveSheet()->setCellValue('DM1', '使用数量');
        $resultPHPExcel->getActiveSheet()->setCellValue('DN1', '权重比例');
        ...
        set_time_limit(0);
        $file_name = "order_list_". date ( "Ymd" ) . ".xls";
//        $str_down = "订单号\t订单日期\t业务类型\t销售类型编号\t客户编码\t客户名称\t部门编码\t业务员编码\t发运方式编码\t发货地址\t联系人\t联系人编码\t币种\t汇率\t表头税率\t付款条件编码\t必有定金\t定金比例\t定金原币金额\t定金本币金额\t表头备注\t订单状态\t制单人\t整单打折标志\t表头自定义项1\t表头自定义项2\t表头自定义项3\t表头自定义项4\t表头自定义项5\t表头自定义项6\t表头自定义项7\t表头自定义项8\t表头自定义项9\t表头自定义项10\t表头自定义项11\t表头自定义项12\t表头自定义项13\t表头自定义项14\t表头自定义项15\t表头自定义项16\t发货地址编码\t收付款协议\t表头预发货日期\t表头预完工日期\t存货编码\t客户存货编码\t客户存货名称\t主计量数量\t件数\t报价含税\t最低售价\t赠品\t报价\t含税单价_原币\t金额_原币_无税\t税额_原币\t价税合计_原币\t折扣额_原币\t无税单价\t单价_本币_无税\t金额_本币_无税\t税额_本币\t价税合计_本币\t折扣额\t备注\t自由项1\t自由项2\t销售订单子表id\t扣率1\t扣率2\t税率\t自定义字段22\t自定义字段23\t自定义字段24\t自定义字段25\t自定义字段26\t自定义字段27\t自定义字段28\t自定义字段29\t自定义字段30\t自定义字段31\t自定义字段32\t自定义字段33\t自定义字段34\t自定义字段35\t自定义字段36\t自定义字段37\t项目\t项目大类\t项目名称\t项目大类名称\t自由项3\t自由项4\t自由项5\t自由项6\t自由项7\t自由项8\t自由项9\t自由项10\t换算率\t辅计量单位编码\t预留失效日期\t预完工日期\t预发货日期\t需求跟踪方式\t母件需求分类代号\t母件需求分类说明\t子件需求分类代号\t子件需求分类说明\t门店销售数量\t门店销售金额\t门店库存数量\t门店要货金额\t父节点编码\t子节点编码\t发货方式\t使用数量\t权重比例";
        ...
        if (!empty($region))
        {
            ...
            {
                $region_arr[$info['region_id']] = $info['region_name'];
            }
        }
        $arr=array();
        $s_fee=array('');
        //print_r($list['orders']);//exit;
        foreach($list['orders'] AS $k=>$v)
        {
            if(isset($arr[$v['order_sn']]))
            {
                array_push($arr[$v['order_sn']],$v);
            }
            else
            {
                $arr[$v['order_sn']][]=$v;
        ...
        foreach($arr AS $k=>$v)
        {
            if($arr[$k][0]['shipping_fee']>0)
            {
                $sf=$arr[$k][0];
                $sf['goods_code']=9904002;
                $sf['goods_price']=$arr[$k][0]['shipping_fee'];
                $sf['goods_number']=1;
                array_push($arr[$k],$sf);
            }
        }
        ...
        reset($arra[0]);//edit by zhuqm 2013-6-4
        $ordersn = '';
        $i=2;
        while ( list ( $key, $val) = each ( $arra[0] ) ) {
            //原始价税合计
            $or_goods_price=$val['goods_price']*$val['goods_number'];
            //产品占总订单百分比
            $goods_percentage=round($or_goods_price/$val['goods_amount']*100).'%';
            //产品折扣额
            $discount_amount3=number_format(($val['discount'])*($or_goods_price/$val['goods_amount']), 2, '.', '');
            //折后产品价税合计
            $discount_amount2=$or_goods_price-$discount_amount3;
            //折后产品含税单价
            $discount_amount=number_format($discount_amount2/$val['goods_number'], 2, '.', '');
            //折后无税金额
            $discount_amount1=number_format($discount_amount2/1.17, 2, '.', '');
            //无税折后单价
            $discount_amount4=number_format($discount_amount2/1.17, 2, '.', '');
            //折扣率
            $discount_amount5=number_format((1-$discount_amount3/$or_goods_price)*100, 2, '.', '');
            if($val['goods_code']==9904002)
            {
                $discount_amount3=0;
                $discount_amount5=100;
            }
            $discount_amount6=$discount_amount2-$discount_amount1;
            $addtime = local_date('Y-m-d', $val['add_time']);

            $resultPHPExcel->getActiveSheet()->setCellValueExplicit('A' . $i, $val['order_sn']);
            $resultPHPExcel->getActiveSheet()->setCellValue('B' . $i, $addtime);
            $resultPHPExcel->getActiveSheet()->setCellValue('C' . $i, '普通销售');
            $resultPHPExcel->getActiveSheet()->setCellValueExplicit('D' . $i, '01');
            $resultPHPExcel->getActiveSheet()->setCellValueExplicit('E' . $i, '01035');
            $resultPHPExcel->getActiveSheet()->setCellValue('F' . $i, '万集客平台');
            $resultPHPExcel->getActiveSheet()->setCellValueExplicit('G' . $i, '04');
            $resultPHPExcel->getActiveSheet()->setCellValue('M' . $i, '人民币');
            $resultPHPExcel->getActiveSheet()->setCellValueExplicit('N' . $i, '1');
            $resultPHPExcel->getActiveSheet()->setCellValueExplicit('O' . $i, '17');
            $resultPHPExcel->getActiveSheet()->setCellValue('W' . $i, '厉传云');
            $resultPHPExcel->getActiveSheet()->setCellValue('Y' . $i, '支付宝');
            $resultPHPExcel->getActiveSheet()->setCellValue('AQ' . $i, $addtime);
            $resultPHPExcel->getActiveSheet()->setCellValue('AR' . $i, $addtime);
            $resultPHPExcel->getActiveSheet()->setCellValueExplicit('AS' . $i, $val['goods_code']);
            $resultPHPExcel->getActiveSheet()->setCellValue('AV' . $i, $val['goods_number']);
            $resultPHPExcel->getActiveSheet()->setCellValueExplicit('AX' . $i, '1');
            $resultPHPExcel->getActiveSheet()->setCellValueExplicit('BA' . $i, '0');
            $resultPHPExcel->getActiveSheet()->setCellValue('BB' . $i, $discount_amount);
            $resultPHPExcel->getActiveSheet()->setCellValue('BC' . $i, $discount_amount1);
            $resultPHPExcel->getActiveSheet()->setCellValue('BD' . $i, $discount_amount6);
            $resultPHPExcel->getActiveSheet()->setCellValue('BE' . $i, $discount_amount2);
            $resultPHPExcel->getActiveSheet()->setCellValue('BF' . $i, $discount_amount3);
            $resultPHPExcel->getActiveSheet()->setCellValue('BG' . $i, $discount_amount4);
            $resultPHPExcel->getActiveSheet()->setCellValue('BQ' . $i, $discount_amount5);
            $resultPHPExcel->getActiveSheet()->setCellValue('BR' . $i, '100');
            $resultPHPExcel->getActiveSheet()->setCellValue('BS' . $i, '17');
            $resultPHPExcel->getActiveSheet()->setCellValue('CY' . $i, $addtime);
            $resultPHPExcel->getActiveSheet()->setCellValue('CZ' . $i, $addtime);

//            if($val['order_sn'] != $ordersn){
////                $str_down .= "\n" . $val ['order_sn'] . "\t" . $val ['order_sn'] . "\t" . $val['goods_name'] . "\t" . $addtime . "\t" . $region_arr[$val['country']] . $region_arr[$val['province']] . $region_arr[$val['city']] . $region_arr[$val['district']] . $val['address'] . "\t" . $val['mobile']. "\t" . $val['tel'] . "\t" . $val['best_time'] . "\t" . $val['consignee'] . "\t" . $val['goods_number'] . "\t" . $val ['discount']. "\t". $val ['tax']. "\t". $val ['shipping_fee']. "\t". $val ['insure_fee']. "\t". $val ['pay_fee']. "\t". $val ['pack_fee']. "\t". $val ['card_fee']. "\t". $goods_totalfee. "\t". $val ['money_paid'] . "\t". $order_status_lang . "\t" . $_LANG['ss'][$shipping_status] . "\t" . $_LANG['ps'][$paystatus] . "\t" . $val['pay_name'] . "\t" . $val['pay_source'];
//                $str_down .= "\n" . $val['order_sn'] . "\t" . $addtime . "\t". '普通销售'. "\t" . '01'. "\t" . '01035'. "\t" . '万集客平台'. "\t" . '04' . "\t" . '' . "\t" . '' . "\t" . '' . "\t" . '' . "\t" . '' . "\t" . '人民币'. "\t" . '1'. "\t" . '17'. "\t" . '' . "\t" . '' . "\t" . '' . "\t" . '' . "\t" . '' . "\t" . '' . "\t" . '' . "\t" . '厉传云'. "\t" . '' . "\t" . '支付宝'. "\t" . '' . "\t" . '' . "\t" . '' . "\t" . '' . "\t" . '' . "\t" . '' . "\t" . '' . "\t" . '' . "\t" . '' . "\t" . '' . "\t" . '' . "\t" . '' . "\t" . '' . "\t" . '' . "\t" . '' . "\t" . '' . "\t" . '' . "\t" . $addtime. "\t" . $addtime. "\t" . '存货码'. "\t" . '' . "\t" . '' . "\t" . $val['goods_number']. "\t" . ''. "\t" . '1'. "\t" . ''. "\t" . ''. "\t" . '0'. "\t" . $val['goods_price']. "\t" . $order_goods_price. "\t" . $order_goods_price1 . "\t" . $order_goods_price2. "\t" . ''. "\t" . ''. "\t" . ''. "\t" . ''. "\t" . ''. "\t" . ''. "\t" . ''. "\t" . ''. "\t" . ''. "\t" . ''. "\t" . ''. "\t" . '扣率'. "\t" . '100'. "\t" . '17'. "\t" . ''. "\t" . ''. "\t" . ''. "\t" . ''. "\t" . ''. "\t" . ''. "\t" . ''. "\t" . ''. "\t" . ''. "\t" . ''. "\t" . ''. "\t" . ''. "\t" . ''. "\t" . ''. "\t" . ''. "\t" . ''. "\t" . ''. "\t" . ''. "\t" . ''. "\t" . ''. "\t" . ''. "\t" . ''. "\t" . ''. "\t" . ''. "\t" . ''. "\t" . ''. "\t" . ''. "\t" . ''. "\t" . ''. "\t" . ''. "\t" . ''. "\t" . $addtime. "\t" . $addtime. "\t" . ''. "\t" . ''. "\t" . ''. "\t" . ''. "\t" . ''. "\t" . ''. "\t" . ''. "\t" . ''. "\t" . ''. "\t" . ''. "\t" . ''. "\t" . ''. "\t" . ''. "\t" . '';
//
//            }
//            else{
////                $str_down .= "\n" . $val['order_sn'] . "\t" . " " . "\t". $val['goods_name'] . "\t" . $addtime . "\t" . $region_arr[$val['country']] . $region_arr[$val['province']] . $region_arr[$val['city']] . $region_arr[$val['district']] . $val['address'] . "\t" . $val['mobile']. "\t" . $val['tel'] . "\t" . $val['best_time'] . "\t" . $val['consignee'] . "\t" . $val['goods_number'] . "\t" . $val ['discount']. "\t". $val ['tax']. "\t". $val ['shipping_fee']. "\t". $val ['insure_fee']. "\t". $val ['pay_fee']. "\t". $val ['pack_fee']. "\t". $val ['card_fee']. "\t". $goods_totalfee. "\t". $val ['money_paid'] . "\t". $order_status_lang . "\t" . $_LANG['ss'][$shipping_status] . "\t" . $_LANG['ps'][$paystatus] . "\t" . $val['pay_name'] . "\t" . $val['pay_source'];
//                $str_down .= "\n" . $val['order_sn'] . "\t" . $addtime . "\t". '普通销售'. "\t" . '01'. "\t" . '01035'. "\t" . '万集客平台'. "\t" . '04' . "\t" . '' . "\t" . '' . "\t" . '' . "\t" . '' . "\t" . '' . "\t" . '人民币'. "\t" . '1'. "\t" . '17'. "\t" . '' . "\t" . '' . "\t" . '' . "\t" . '' . "\t" . '' . "\t" . '' . "\t" . '' . "\t" . '厉传云'. "\t" . '' . "\t" . '支付宝'. "\t" . '' . "\t" . '' . "\t" . '' . "\t" . '' . "\t" . '' . "\t" . '' . "\t" . '' . "\t" . '' . "\t" . '' . "\t" . '' . "\t" . '' . "\t" . '' . "\t" . '' . "\t" . '' . "\t" . '' . "\t" . '' . "\t" . '' . "\t" . $addtime. "\t" . $addtime. "\t" . '存货码'. "\t" . '' . "\t" . '' . "\t" . $val['goods_number']. "\t" . ''. "\t" . '1'. "\t" . ''. "\t" . ''. "\t" . '0'. "\t" . $val['goods_price']. "\t" . $order_goods_price. "\t" . $order_goods_price1 . "\t" . $order_goods_price2. "\t" . ''. "\t" . ''. "\t" . ''. "\t" . ''. "\t" . ''. "\t" . ''. "\t" . ''. "\t" . ''. "\t" . ''. "\t" . ''. "\t" . ''. "\t" . '扣率'. "\t" . '100'. "\t" . '17'. "\t" . ''. "\t" . ''. "\t" . ''. "\t" . ''. "\t" . ''. "\t" . ''. "\t" . ''. "\t" . ''. "\t" . ''. "\t" . ''. "\t" . ''. "\t" . ''. "\t" . ''. "\t" . ''. "\t" . ''. "\t" . ''. "\t" . ''. "\t" . ''. "\t" . ''. "\t" . ''. "\t" . ''. "\t" . ''. "\t" . ''. "\t" . ''. "\t" . ''. "\t" . ''. "\t" . ''. "\t" . ''. "\t" . ''. "\t" . ''. "\t" . ''. "\t" . $addtime. "\t" . $addtime. "\t" . ''. "\t" . ''. "\t" . ''. "\t" . ''. "\t" . ''. "\t" . ''. "\t" . ''. "\t" . ''. "\t" . ''. "\t" . ''. "\t" . ''. "\t" . ''. "\t" . ''. "\t" . '';
//
//            }
...
//        header("Last-Modified: " . gmdate("D, d M Y H:i:s") . " GMT");
    ...
    if ($_REQUEST['download']=='对账下载') {
        // 导出到文本;
        ini_set('memory_limit',-1);
        set_time_limit(0);
        $file_name = "order_list_". date ( "Ymd" ) . ".csv";
        $str_down = "订单号\t下单时间\t购货人\t付款日期\t商品总金额\t配送费用\t保价费\t支付费用\t使用积分\t贺卡费用\t折扣金额\t使用余额\t红包金额\t礼品卡\t已付款金额\t支付方式";
        ...
        $order_list = array();
        while ( list ( $key, $val ) = each ( $list['orders'] ) ) {
            if($val['parent_orderid'] > 0 && array_key_exists($val['parent_orderid'],$order_list)){
                $order_list[$val['parent_orderid']]['goods_totalfee'] += $val['goods_amount'];
                $order_list[$val['parent_orderid']]['shipping_fee'] += $val['shipping_fee'];
                $order_list[$val['parent_orderid']]['insure_fee'] += $val['insure_fee'];
                $order_list[$val['parent_orderid']]['pay_fee'] += $val['pay_fee'];
                $order_list[$val['parent_orderid']]['integral_money'] += $val['integral_money'];
                $order_list[$val['parent_orderid']]['card_fee'] += $val['card_fee'];
                $order_list[$val['parent_orderid']]['discount'] += $val['discount'];
                $order_list[$val['parent_orderid']]['surplus'] += $val['surplus'];
                $order_list[$val['parent_orderid']]['bonus'] += $val['bonus'];
                $order_list[$val['parent_orderid']]['gift_money'] += $val['gift_money'];
                $order_list[$val['parent_orderid']]['money_paid'] += $val['money_paid'];
            }
            else{
                $order_list[$val['order_id']]['order_sn'] = $val['order_sn'];
                $order_list[$val['order_id']]['add_time'] = local_date('Y-m-d H:i:s', $val['add_time']);
                $order_list[$val['order_id']]['user_name'] = $val['user_name'];
                $order_list[$val['order_id']]['pay_time'] = $val['pay_time']==null ? '' : local_date('Y-m-d H:i:s', $val['pay_time']);
                $order_list[$val['order_id']]['goods_totalfee'] = $val['goods_amount'];
                $order_list[$val['order_id']]['shipping_fee'] = $val['shipping_fee'];
                $order_list[$val['order_id']]['insure_fee'] = $val['insure_fee'];
                $order_list[$val['order_id']]['pay_fee'] = $val['pay_fee'];
                $order_list[$val['order_id']]['integral_money'] = $val['integral_money'];
                $order_list[$val['order_id']]['card_fee'] = $val['card_fee'];
                $order_list[$val['order_id']]['discount'] = $val['discount'];
                $order_list[$val['order_id']]['surplus'] = $val['surplus'];
                $order_list[$val['order_id']]['bonus'] = $val['bonus'];
                $order_list[$val['order_id']]['gift_money'] = $val['gift_money'];
                $order_list[$val['order_id']]['money_paid'] = $val['money_paid'];
                $order_list[$val['order_id']]['pay_name'] = $val['pay_name'];
            }
        }
        foreach ($order_list as $val) {
            $str_down .= "\n" . $val ['order_sn']. "\t". $val['add_time'] . "\t". $val['user_name']. "\t". $val['pay_time']  . "\t" . $val['goods_totalfee']. "\t" . $val['shipping_fee'] . "\t" . $val['insure_fee'] . "\t" . $val['pay_fee'] . "\t" . $val['integral_money'] . "\t" . $val ['card_fee']. "\t". $val ['discount']. "\t". $val ['surplus']. "\t". $val ['bonus']. "\t". $val ['gift_money']. "\t". $val ['money_paid']. "\t". $val ['pay_name'];
        }
    ...
    if ($_REQUEST['download']=='明细下载') {
        // 导出到文本;
        ini_set('memory_limit',-1);
        set_time_limit(0);
        $file_name = "order_list_". date ( "Ymd" ) . ".csv";
        $str_down = "订单号\t下单时间\t购货人\t付款日期\t商品总金额\t配送费用\t手机号\t支付费用\t使用积分\t用户名\t折扣金额\t使用余额\t红包金额\t礼品卡\t已付款金额\t支付方式\t是否海淘\t所属仓库\t红包ID\t红包类型名称\t红包编号\t礼品卡名称";
        ...
        while ( list ( $key, $val ) = each ( $list['orders'] ) ) {
            ...
            $val['pay_time'] = $val['pay_time']==null ? '' : local_date('Y-m-d H:i:s', $val['pay_time']);
            $val['is_overseas'] = $val['is_overseas'] ? "是" : "否";
            $str_down .= "\n" . $val ['order_sn']. "\t". $val['add_time']. "\t". $val['user_name'] . "\t". $val['pay_time'] . "\t" . $val['goods_amount']. "\t" . $val['shipping_fee'] . "\t" . $val['tel'] . "\t" . $val['pay_fee'] . "\t" . $val['integral_money'] . "\t" . $val ['user_name']. "\t". $val ['discount']. "\t". $val ['surplus']. "\t". $val ['bonus']. "\t". $val ['gift_money']. "\t". $val ['money_paid']. "\t". $val ['pay_name']. "\t". $val ['is_overseas']. "\t". $val ['warehouse_type']. "\t". $val ['bonus_type_id']. "\t". $val ['type_name']. "\t". $val ['bonus_id']. "\t". $val ['goods_name'];
        }
    ...
    if ($_REQUEST['download']=='线下海淘下载') {
        // 导出到文本;
        ini_set('memory_limit',-1);
        set_time_limit(0);
        $file_name = "order_list_". date ( "Ymd" ) . ".csv";
        $str_down = "订单号\t商品名称\t订购数量\t下单时间\t商品金额\t结算金额\t客户姓名\t客户地址\t联系电话\t订单备注\t运费金额\tkjtid\t省\t市\t区\t身份证号码\t订单状态\t支付状态";
        ...
        //print_r($list['orders']);//exit;
        reset($list['orders']);//edit by zhuqm 2013-6-4

        $ordersn = '';
        while ( list ( $key, $val ) = each ( $list['orders'] ) ) {
            $paystatus = $val['pay_status'];
            $order_status = $val['order_status'];
            $order_status_lang = str_replace('<font color="red">', '', $_LANG['os'][$order_status]);
            $order_status_lang = str_replace('</font>', '', $order_status_lang);
            $addtime = local_date('Y-m-d H:i:s', $val ['add_time']);
            $goods_totalfee = $val['goods_number'] * $val['goods_price'];
            $val['goods_name'] = str_replace("\t", '', $val['goods_name']);
            $str_down .= "\n" . $val ['order_sn'] .  "\t". $val['goods_name']. "\t" . $val['goods_number'] . "\t" . $addtime ."\t". $goods_totalfee. "\t" . '' .
                "\t" . $val['consignee']. "\t"  . $val['address']  . "\t" . $val['tel'].  "\t" . ''.   "\t". $val ['shipping_fee'] . "\t". $val ['kjt_goods_id'] .
                "\t"  . $region_arr[$val['province']]  ."\t" . $region_arr[$val['city']] . "\t"  . $region_arr[$val['district']]. "\t" . "'".$val ['id_card'] ."\t".
                $order_status_lang . "\t" . $_LANG['ps'][$paystatus];
        }
    ...
    if ($_REQUEST['download']=='购买会员订单下载') {
        // 导出到文本;
        ini_set('memory_limit',-1);
        set_time_limit(0);
        $file_name = "is_members_list". date ( "Ymd" ) . ".csv";
        $str_down = "用户名\t购买时间\t过期时间\t会员名称\t收货人\t电话\t地址\t\t\t";
        $_REQUEST['is_members']=1;
        $list = order_list(0);
        $region_arr = array();
        $region = $db->getAll("SELECT region_id, region_name FROM " . $ecs->table("region"));
        if (!empty($region))
        ...
        $ordersn = '';
        while ( list ( $key, $val ) = each ( $list['orders'] ) ) {
            $address = address_info($val['address_id']);
            $addtime = local_date('Y-m-d H:i:s', $val ['add_time']);
            $endtime = local_date('Y-m-d H:i:s', $val ['members_deadline']);
            $str_down .= "\n" . $val ['user_name'] .  "\t". $addtime .  "\t". $endtime. "\t" . $val['goods_name'] . "\t" . $address['consignee'] ."\t". $address['tel'].
            "\t"  . $region_arr[$address['province']]  ."\t" . $region_arr[$address['city']] . "\t"  . $region_arr[$address['district']]. "\t" . $address ['address'];
        }
...
elseif ($_REQUEST['act'] == 'info')
{
    ...
    if($order['order_status']==1 || $order['order_status'] == 5 )
    {
        ...
        {
            if($order['shipping_status'] == 1 || $order['shipping_status'] == 7 || $order['shipping_status'] == 2)
            {
                $smarty->assign('order_refund_attr', 1);
            }
        }
    }
    /* 取得订单的来源 */
    ...
    /* 参数赋值：订单 */
    if(!empty($order['parent_orderid'])){
        $parent_orderid = $order['parent_orderid'];
        if($order['parent_orderid'] == $order['order_id']){
            $order['parent_ordersn_name'] = '子订单号';
            $sql = "SELECT order_sn FROM " . $GLOBALS['ecs']->table('order_info') .
                " WHERE parent_orderid = '$parent_orderid'";
            $ordersn = $GLOBALS['db']->getAll($sql);
            if(count($ordersn) > 0){
                foreach($ordersn as $val){
                    $order_sn = $val["order_sn"];
                    $order_sn_url = "<a href='order.php?act=info&order_sn="."$order_sn' target='_blank'>$order_sn</a>";
                    $order['parent_ordersn'] .= ($order_sn_url.',');
                }
                $order['parent_ordersn'] = substr($order['parent_ordersn'], 0, -1);
            }
        }
        else{
            $order['parent_ordersn'] = '无';
            $order['parent_ordersn_name'] = '主订单号';
            $sql = "SELECT order_sn FROM " . $GLOBALS['ecs']->table('order_info') .
                " WHERE order_id = '$parent_orderid'";
            $ordersn = $GLOBALS['db']->getOne($sql);
            if(!empty($ordersn)){
                $order['parent_ordersn'] = $ordersn;
            }
        }
    }
    if($order['bonus_id']>0)
    {
        $sql = "SELECT type_name FROM " . $GLOBALS['ecs']->table('bonus_type') . " b LEFT JOIN " . $GLOBALS['ecs']->table('user_bonus') .
            " u ON b.type_id=u.bonus_type_id WHERE bonus_id = '$order[bonus_id]'";
        $bonus_info = $GLOBALS['db']->getOne($sql);
        $order['bonus_name'] = $bonus_info;
    }
    $smarty->assign('order', $order);

    /* 取得海淘信息 */
    $s="SELECT updatetime,return_code,return_desc,customs_desc,sft_status,billing_desc,sft_paytime FROM ". $ecs->table('kjt_task') ."WHERE order_no=$order[order_sn] ";
    $overseas = $db->getRow($s);

    switch($overseas['sft_status'])
    {
        case BILLING_SUCC :
            $overseas['sft_status'] = '代扣成功';
            break;

        case BILLING_FAL :
            $overseas['sft_status'] = '代扣失败';
            break;

        case DECLARE_SUCC :
            $overseas['sft_status'] = '支付申报成功';
            break;

        case DECLARE_FAL :
            $overseas['sft_status'] = '支付申报失败';
            break;

        case DECLARE_NOTICE_SUCC :
            $overseas['sft_status'] = '支付申报通知成功';
            break;

        case DECLARE_NOTICE_FAL :
            $overseas['sft_status'] = '支付申报通知失败';
            break;
    }
    $overseas['updatetime']=!empty($overseas['updatetime']) ? local_date('Y-m-d H:i:s',$overseas['updatetime']) : "";
    $overseas['sft_paytime']=!empty($overseas['sft_paytime']) ? local_date('Y-m-d H:i:s',($overseas['sft_paytime'] - 28800)) : "";
    /* 参数赋值：海淘信息 */
    ...
    if ($order['user_id'] > 0)
    {
        ...
        $sql = "SELECT COUNT(*) " .
                ...
                "AND ub.order_id = 0 " .
                "AND ub.use_start_datetime <= '$today' " .
                "AND ub.use_end_datetime >= '$today'";
    ...
    while ($row = $db->fetchRow($res))
    {
        ...
        if($row['refund_num'] == $row['goods_number']){
            $row['refund_attr'] = '退款';
        }
        elseif($row['refund_num'] == 0){
            $row['refund_attr'] = '已退款';
        }
        else{
            $row['refund_attr'] = '部分退款';
        }
        $goods_list[] = $row;
    }
    ...
    //退款商品
    $refund_sql = "SELECT t1.*,t2.goods_name,t2.goods_sn,t2.goods_price FROM " . $ecs->table('refund_log') . " AS t1
                LEFT JOIN " . $ecs->table('order_goods') . " AS t2 ON t1.refund_order_goodsid = t2.rec_id
            WHERE t1.order_sn = '$order[order_sn]'";
    $res = $db->query($refund_sql);

    $refund_list = array();
    while ($row = $db->fetchRow($res))
    {
        $row['formated_goods_price']    = price_format($row['goods_price']);
        $row['formated_refund_gift']    = price_format($row['refund_gift']);
        $row['formated_refund_money']    = price_format($row['refund_money']);
        $row['formated_comfort_money']    = price_format($row['comfort_money']);
        $row['formated_refund_amount']    = price_format($row['refund_gift']+$row['refund_money']);
...
elseif ($_REQUEST['act'] == 'goods_info')
{
    ...
    /* 取得订单商品及货品 */
    $goods_list = array();
    $sql = "SELECT * FROM " . $ecs->table('order_goods') . " WHERE rec_id = $rec_id";
    $res = $db->query($sql);
    while ($row = $db->fetchRow($res))
    {
        $row['formated_subtotal']       = price_format($row['goods_price'] * $row['goods_number']);
        $row['formated_refund_price']    = price_format($row['refund_gift'] + $row['refund_money']);
        $goods_list[] = $row;
    }

    /* 模板赋值 */
    $smarty->assign('ur_here', '退款申请');
    $smarty->assign('action_link', array('href' => 'order.php?act=list&' . list_link_postfix(), 'text' => $_LANG['02_order_list']));
    $smarty->assign('goods_list', $goods_list);
    ...
    /* 显示模板 */
    assign_query_info();
    $smarty->display('refund_info.htm');
}
...
elseif ($_REQUEST['act'] == 'step_post')
{
    ...
    /* 取得参数 step */
    $step_list = array('user', 'edit_goods', 'add_goods', 'goods', 'consignee', 'shipping', 'payment', 'other', 'money', 'invoice', 'refund');
...
//                    update_order($order_id, array('pay_id' => 0, 'pay_name' => ''));
    ...
    elseif ('refund' == $step)
    {
        $_POST["refund_goods_num"] = floatval($_POST["refund_goods_num"]);
        $sq = "SELECT refund_num FROM ". $ecs->table('order_goods') ." WHERE rec_id=".$_POST['rec_id'];
        $refund_num = $db->getOne($sq);
        $sq1 = "SELECT refund_money FROM ". $ecs->table('order_goods') ." WHERE rec_id=".$_POST['rec_id'];
        $refund_money = $db->getOne($sq1);
        $new_refund_num = $refund_num - $_POST["refund_goods_num"];
        ...
        //退款操作判断
        $pay_status = 0;
        $refund_sql = "SELECT t1.pay_status,t2.rec_id,t2.refund_num FROM " . $ecs->table('order_info') . " AS t1
                LEFT JOIN " . $ecs->table('order_goods') . " AS t2 ON t1.order_id = t2.order_id
            WHERE t1.order_sn = '$_POST[order_sn]'";
        $refund = $db->getAll($refund_sql);
        foreach($refund AS $value)
        {
            if(($_POST['rec_id'] == $value['rec_id']) && ($new_refund_num == 0))
            {
                $pay_status++;
            }
        ...
        admin_log('退款'.$_POST["order_sn"], 'insert', 'refund');
        $time = gmtime();
        $sql = "INSERT INTO " .$GLOBALS['ecs']->table('refund_log').
            " (order_sn, user_id, refund_goods_id, refund_goods_num, refund_discount, refund_bonus, refund_gift, refund_money, comfort_money, comfort_reason, refund_order_goodsid, add_time)" .
            "VALUES ('$_POST[order_sn]', '$_POST[user_id]', '$_POST[refund_goods_id]', '$_POST[refund_goods_num]', '$_POST[refund_discount]', '$_POST[refund_bonus]', '$_POST[refund_gift]', '$_POST[refund_money]', '$_POST[comfort_money]', '$_POST[comfort_reason]', '$_POST[rec_id]', '$time')";
        $db->query($sql);
        $update_sql = "UPDATE ". $ecs->table('order_goods') ." SET refund_num=".$new_refund_num." WHERE rec_id=".$_POST['rec_id'];
        $db->query($update_sql);
        if($refund[0]['pay_status'] != $pay_status)
        {
            $updatesql = "UPDATE ". $ecs->table('order_info') ." SET pay_status=".$pay_status." WHERE order_sn='$_POST[order_sn]'";
            $db->query($updatesql);
        }
        //检查是否已赠送积分
        $integral_r = is_send_integral($_POST['order_sn']);
        if($integral_r > 0)
        {
            $order = order_info(0,$_POST['order_sn']);
            $integrals = $refund_money * $_POST["refund_goods_num"] * $order['integrals'];
            log_account_change($_POST['user_id'], 0, 0, 0,  (-1) * intval($integrals), sprintf($_LANG['refund_order_gift_integral'], $order['order_sn']));
        }
        ecs_header("Location: order.php?act=info&order_sn=" . $_REQUEST['order_sn'] . "\n");
        exit;
    }
}
...
elseif ($_REQUEST['act'] == 'add' || $_REQUEST['act'] == 'edit')
{
    ...
    elseif ('shipping' == $step)
    {
        ...
        {
            $configure = unserialize($shipping['configure']);
            $shipping_fee = shipping_fee($shipping['shipping_code'],
                $configure, $total['weight'], $total['amount'], $total['number']);
...
elseif ($_REQUEST['act'] == 'operate')
{
    ...
    /* 拆单 */
    elseif (isset($_POST['split_order']))
    {
//        /* 检查权限 */
//        admin_priv('order_ps_edit');
        //拆单逻辑
        $require_note   = $_CFG['order_split_note'] == 1;
        $action         = $_LANG['split_order'];
...
//                        $child_order['kjt_pay_tradeno'] = $child_order['pay_trade_no'];
        ...
        /* 记录log */
        order_action($order['order_sn'], $order['order_status'], $order['shipping_status'], $order['pay_status'], '拆单');
    }
    /* 设为未付款 */
    ...
    elseif ('unship' == $operation)
    {
        ...
        if ($order['user_id'] > 0)
        {
            ...
            //检查是否已赠送积分
            $integral_r = is_send_integral($order['order_sn']);
            if($integral_r > 0)
            {
                /* 计算并退回积分 */
                $integral = integral_to_give($order);
...
elseif ($_REQUEST['act'] == 'order_upload')
{
    //上传订单文件
    if(! empty ( $_FILES ['upload_file'] ['name'] ))
    {
        ...
        /*设置上传路径*/
        $savePath = ROOT_PATH . 'public/upfile/Excel/';
        ...
        */
        ...
        for($j=2;$j<=$highestRow;$j++)
        {
            ...
            $b = $objPHPExcel->getActiveSheet()->getCell("AS".$j)->getValue();
            //判断
            if($b!=9904002)//排除运费存货码
            {
                if(isset($arr[$a]))
                {
                    array_push($arr[$a],$b);
        ...
        foreach ( $arr as $k => $v )
        {
            $order = order_info(0, $k);
            $sql = "SELECT g.goods_code
            FROM " . $ecs->table('order_goods') . " AS o
                LEFT JOIN " . $ecs->table('goods') . " AS g
                    ON o.goods_id = g.goods_id
            WHERE o.order_id = '$order[order_id]'";
            ...
            foreach($res AS $value)
            {
                foreach($v AS $val)
                {
                    if($value['goods_code']==strval($val))
                    {
                        $x++;continue;
                    }
                }
            ...
            if($x==count($res))
            {
                $sql = 'SELECT order_status,shipping_status FROM ' . $GLOBALS['ecs']->table('order_info') . " WHERE order_sn = '$k'";
                $order_status = $GLOBALS['db']->getRow($sql);
                if($order_status['order_status']==1 && $order_status['shipping_status']==0)
                {
                    $sql = 'UPDATE ' . $GLOBALS['ecs']->table('order_info') . " SET shipping_status=3 WHERE order_sn = '$k'";
                    if($GLOBALS['db']->query($sql))
                    {
                        $num1++;continue;
                    }
...
elseif ($_REQUEST['act'] == 'order_import')
{
    $smarty->assign('ur_here',          $_LANG['13_order_import']);
    $smarty->assign('action_link',      array('text' => $_LANG['13_order_import'], 'href'=>'order.php?act=order_import'));
...
elseif ($_REQUEST['act'] == 'warehouse_upload')
{
    exit;
    //上传订单文件
    if(! empty ( $_FILES ['upload_file'] ['name'] ))
        ...
        */
        ...
        foreach ( $arr as $k => $v )
        {
            ...
            if($x==count($res))
            {
                $sql = 'SELECT order_status,shipping_status FROM ' . $GLOBALS['ecs']->table('order_info') . " WHERE order_sn = '$k'";
                $order_status = $GLOBALS['db']->getRow($sql);
                if($order_status['order_status']==1 && $order_status['shipping_status']==3)
                {
                    $sql = 'UPDATE ' . $GLOBALS['ecs']->table('order_info') . " SET shipping_status=1 WHERE order_sn = '$k'";
                    if($GLOBALS['db']->query($sql))
                    {
                        $num1++;continue;
                    }
...
elseif ($_REQUEST['act'] == 'warehouse_line_upload')
{
    //上传订单文件
    if(! empty ( $_FILES ['upload_file'] ['name'] ))
    {
        ...
        */
        ...
        for($j=2;$j<=$highestRow;$j++)
        {
            ...
            $b = $objPHPExcel->getActiveSheet()->getCell("B".$j)->getValue();//物流公司
            $c = $objPHPExcel->getActiveSheet()->getCell("C".$j)->getValue();//物流单号
            if($a!=null)
            {
                $arr[$a][]=($b == '圆通快递') ? '圆通速递' : $b;
                $arr[$a][]=$c;
        ...
        {
            $order = order_info(0, $k);
            //查看是否为符合修改的订单：已确认已付款（不是已发货）
            if($order['order_status'] != 1 || $order['pay_status'] != 2 || $order['shipping_status'] == 1)
            {
                $num2++;continue;
            }
            //修改订单状态已分单已付款已发货、物流公司、物流单号
            $sql = 'UPDATE ' . $GLOBALS['ecs']->table('order_info') . " SET order_status=5,shipping_status=1,shipping_name='$v[0]',shipping_time=$now,invoice_no='$v[1]' WHERE order_sn = '$k'";
            if($GLOBALS['db']->query($sql))
            {
                $num1++;
            }
...
elseif ($_REQUEST['act'] == 'warehouse_import')
{
    $smarty->assign('ur_here',          $_LANG['14_warehouse_import']);

    $smarty->display('warehouse_import.htm');
}
...
elseif ($_REQUEST['act'] == 'warehouse_line_import')
{
    $smarty->assign('ur_here',          $_LANG['15_warehouse_line_import']);

    $smarty->display('warehouse_line_import.htm');
}
    ...
    elseif (OS_CONFIRMED == $os || OS_SPLITED == $os || OS_SPLITING_PART == $os)
    {
        ...
        else
        {
            ...
            if (SS_UNSHIPPED == $ss || SS_PREPARING == $ss)
            {
                ...
                {
                    $list['cancel'] = true; // 取消
                    $list['split_order'] = true; // 拆单
                }
                else
                {
                    $goods_number = get_ordergoods_num($order['order_id']);
                    if($order['is_overseas'] && $order['goods_amount'] > 2000 && $goods_number > 1){
                        $list['cancel'] = true; // 取消
                        $list['split_order'] = true; // 拆单
                    }
                    else{
...
function order_list($flag=true)
{
    ...
    if ($result === false)
    {
        ...
        $filter['supplier_status'] = empty($_REQUEST['supplier_status']) ? '' : trim($_REQUEST['supplier_status']);
        $filter['is_overseas'] = empty($_REQUEST['is_overseas']) ? -1 : trim($_REQUEST['is_overseas']);
        $filter['is_members'] = empty($_REQUEST['is_members']) ? -1 : trim($_REQUEST['is_members']);
        $filter['is_pushsuccess'] = empty($_REQUEST['is_pushsuccess']) ? -1 : trim($_REQUEST['is_pushsuccess']);
        ...
        $filter['warehouse_id'] = empty($_REQUEST['warehouse_id']) ? 0 : intval($_REQUEST['warehouse_id']);
        ...
        if(!$flag)
        {
            ...
            {
                $where .= " AND g.supplier_id  = '$filter[warehouse_id]'";
            }
        }
        if ($filter['pay_id'])
        {
        ...
        if ($_REQUEST['download']=='对账下载' || $_REQUEST['download']=='明细下载') {
        ...
        {
            $where .= " AND o.supplier_status = '$filter[supplier_status]'";
        }
        if ($filter['is_overseas'] != -1)
        {
            if($filter['is_overseas']==2)
            {
                $filter['is_overseas']=0;
            }
            $where .= " AND o.is_overseas = '$filter[is_overseas]'";
        }
        if ($filter['is_members'] != -1)
        {
            if($filter['is_members']==1)
            {
                $where .= " AND o.extension_code = 'goods_members'";
            }
            else
            {
                $where .= " AND o.extension_code <> 'goods_members'";
        ...
        if ($filter['is_pushsuccess'] != -1)
        {
            if($filter['is_pushsuccess'] == 1)
            {
                $where .= " AND t.task_status = 11";
            }
            else
            {
                $where .= " AND (t.task_status = 12 or t.task_status = 14 or t.sft_status = 12 or t.sft_status = 22 or t.sft_status = 32) AND t.task_status <> 13";
            }
        }
        ...
        switch($filter['composite_status'])
        {
            ...
            case SS_SHIPPED_KJT :
                if ($filter['composite_status'] != -1)
                {
                    $where .= " AND o.shipping_status  = '$filter[composite_status]' ";
                }
                break;
            default:
                if ($filter['composite_status'] != -1)
        ...
        if ($_REQUEST['download']=='自营用友下载' || $_REQUEST['download']=='对账下载' ||$_REQUEST['download']=='明细下载' || $_REQUEST['download']=='线下海淘下载' || $_REQUEST['download']=='购买会员订单下载') {
            //ini_set ('memory_limit', '1024M');
            $filter['page_size'] = 50000000;
        }

        /* 记录总数 */
        if ($filter['user_name'] || $filter['is_members'])
        {
...
//                   $GLOBALS['ecs']->table('users') . " AS u " . $where;
            $sql = "SELECT COUNT(*) FROM " . $GLOBALS['ecs']->table('order_info') . " AS o inner join".
                $GLOBALS['ecs']->table('users') . " AS u on o.user_id = u.user_id inner join" .$GLOBALS['ecs']->table('order_goods')
                . " AS g on o.order_id = g.order_id left join ".$GLOBALS['ecs']->table('kjt_task').
                " AS t on o.order_sn=t.order_no ". $where;
        }
        else
        {
            $sql = "SELECT COUNT(*) FROM " . $GLOBALS['ecs']->table('order_info') . " AS o ". " LEFT JOIN ".$GLOBALS['ecs']->table('kjt_task').
                " AS t on o.order_sn=t.order_no ". " LEFT JOIN ".$GLOBALS['ecs']->table('order_goods')
                . " AS g on o.order_id = g.order_id " .$where;
        }
        ...
        if($flag)
        {
            ...
            {
                /* 查询 */
                $sql = "SELECT DISTINCT(o.order_id),o.order_id, o.parent_orderid, o.order_sn, o.add_time, o.order_status, o.shipping_status, o.order_amount, o.money_paid," .
                    "o.pay_status, o.surplus, o.bonus, o.gift_money,o.tel, o.extension_id,o.order_source, " .
                    "o.discount,o.shipping_fee,o.pay_fee,o.pack_fee,o.integral_money,o.pay_time,o.goods_amount,o.pay_name,u.user_name,u.members_deadline,ggs.goods_name,bt.type_name,ub.bonus_type_id,ub.bonus_id,gsu.warehouse_type, " .
                    "(" . order_amount_field('o.') . ") AS total_fee, " .
                    "IFNULL(u.user_name, '" .$GLOBALS['_LANG']['anonymous']. "') AS buyer,o.is_overseas ".
                    " FROM " . $GLOBALS['ecs']->table('order_info') . " AS o " .
                    " LEFT JOIN " .$GLOBALS['ecs']->table('gift_card'). " AS gc ON gc.card_id=o.gift_card_id".
                    " LEFT JOIN " .$GLOBALS['ecs']->table('goods'). " AS ggs ON ggs.goods_id=gc.goods_id".
                    " LEFT JOIN " .$GLOBALS['ecs']->table('users'). " AS u ON u.user_id=o.user_id".
                    " LEFT JOIN " .$GLOBALS['ecs']->table('user_bonus'). " AS ub ON ub.bonus_id=o.bonus_id".
                    ...
                    " LEFT JOIN " .$GLOBALS['ecs']->table('goods_supplier') . " AS gsu ON gs.supplier_id=gsu.type_id " .
                    " LEFT JOIN " .$GLOBALS['ecs']->table('kjt_task')." AS t ON o.order_sn=t.order_no " . $where .
            ...
            {
                /* 查询 */
                $sql = "SELECT o.order_id, o.parent_orderid, o.order_sn, o.add_time, o.order_status, o.shipping_status, o.order_amount, o.money_paid," .
                    "o.pay_status, o.surplus, o.bonus, o.gift_money, o.consignee, o.address, o.email, o.tel, o.extension_code, o.extension_id,o.order_source, " .
                    "o.discount,o.shipping_fee,o.insure_fee,o.pay_fee,o.pack_fee,o.integral_money,o.card_fee,o.pay_time,o.goods_amount,o.pay_name,u.user_name,u.members_deadline, " .
                    "(" . order_amount_field('o.') . ") AS total_fee, " .
                    "IFNULL(u.user_name, '" .$GLOBALS['_LANG']['anonymous']. "') AS buyer,o.is_overseas ".
                    " FROM " . $GLOBALS['ecs']->table('order_info') . " AS o " .
                    " LEFT JOIN " .$GLOBALS['ecs']->table('users'). " AS u ON u.user_id=o.user_id".
        ...
        {
            /* 查询 */
            $sql = "SELECT o.order_id, o.parent_orderid, o.order_sn, o.add_time, o.order_status, o.shipping_status,o.goods_amount, o.order_amount, o.money_paid,o.shipping_fee,o.id_card," .
                "o.pay_status, o.province, o.city, o.district, o.consignee, o.address, o.email, o.tel, o.extension_code, o.extension_id,g.goods_price,g.goods_number,u.address_id,u.user_name,".
                "g.goods_name,o.discount, o.surplus, o.bonus, o.gift_money,gs.goods_code,gs.kjt_goods_id,u.user_name,u.members_deadline,o.order_source, " .
                "o.discount,o.shipping_fee,o.insure_fee,o.pay_fee,o.pack_fee,o.integral_money,o.card_fee,o.pay_time,o.goods_amount, " .
                "(" . order_amount_field('o.') . ") AS total_fee, " .
                "IFNULL(u.user_name, '" .$GLOBALS['_LANG']['anonymous']. "') AS buyer,o.is_overseas ".
                " FROM " . $GLOBALS['ecs']->table('order_info') . " AS o " .
                " LEFT JOIN " .$GLOBALS['ecs']->table('users'). " AS u ON u.user_id=o.user_id".
